...
int CGMOdbcManager::CreateNewCharacter(SCHARDATA2* pCharData2, int nSvrNum)
{
	...
	strTemp << "ChaAttackP, ChaDefenseP, ChaFightA, ChaShootA, ChaMagicA, ChaExp, ";
	...
	strTemp << pCharData2->m_powerAttribute[SKILL::EMAPPLY_MAGIC] << ",";
...
int CGMOdbcManager::GetCharacterInfo(int nChaNum, int nUserNumber, GLCHARLOGIC* pChaData2)
{
	...
	strSQL << " ChaDefenseP, ChaFightA, ChaShootA, ChaMagicA, ChaSP, ChaPK, ";
	...
	SQLINTEGER nChaMagicA, cbChaMagicA=SQL_NTS;
	...
	while(TRUE)
	{
		...
		{				
			...
			::SQLGetData(hStmt,28, SQL_C_LONG, &nChaMagicA,     0, &cbChaMagicA);
...
int	CGMOdbcManager::SaveCharacterBase(LPVOID _pbuffer)
{
	...
	strTemp << ", ChaMagicA="   << (int) pCharData2->m_powerAttribute[SKILL::EMAPPLY_MAGIC];
...
int	CGMOdbcManager::SaveCharacter ( LPVOID _pbuffer )
{
	...
	strTemp << ", ChaMagicA="   << pCharData2->m_powerAttribute[SKILL::EMAPPLY_MAGIC];
	strTemp << ", ChaExp=" << pCharData2->m_sExperience.lnNow;
