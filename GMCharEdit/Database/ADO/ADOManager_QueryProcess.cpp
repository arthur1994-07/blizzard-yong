...
int CADOManager::GetUserNum( CString strUserID )
{
	...
	csQuery.Empty();
	csQuery.Format(_T(
		"IF OBJECT_ID(N'dbo.GSUserInfo', N'U') IS NOT NULL "
		"BEGIN "
		"\tSELECT UserNum FROM dbo.GSUserInfo WHERE UserID='%s' "
		"END "
		"ELSE "
		"BEGIN "
		"\tSELECT UserNum FROM dbo.UserInfo WHERE UserID='%s' "
		"END"),
		strUserID.GetBuffer(),
		strUserID.GetBuffer());
...
int CADOManager::CreateNewCharacter( SCHARDATA2* pCharData2, int nSvrNum )
{
	...
	csQuery.Format(_T(
					...
					"INSERT INTO ChaInfo "												\
						...
						"ChaAttackP, ChaDefenseP, ChaFightA, ChaShootA, ChaMagicA, ChaExp, "		\
		...
		, pCharData2->m_powerAttack, pCharData2->m_powerDefence, (int)pCharData2->m_powerAttribute[SKILL::EMAPPLY_MELEE], (int)pCharData2->m_powerAttribute[SKILL::EMAPPLY_RANGE], (int)pCharData2->m_powerAttribute[SKILL::EMAPPLY_MAGIC], pCharData2->m_sExperience.lnNow
...
int CADOManager::SaveCharacterBase( LPVOID _pbuffer )
{
    ...
    std::string Query = stringformat(
		"UPDATE ChaInfo SET "																	    	        \
			...
			"ChaReturnPosX= %36%, ChaReturnPosY= %37%, ChaReturnPosZ= %38%, ChaInvenLine= %39%, ChaCP= %40%, SkillSlotNum=%41%, SkillSlotNum=%42% "	\
		"WHERE ChaNum = %43% "
		...
		, (int)p->m_powerAttribute[SKILL::EMAPPLY_MAGIC], (int)dwChaNum
		);
...
int CADOManager::SaveCharacter( LPVOID _pbuffer )
{
	...
	csQuery.Format(_T(
		"UPDATE ChaInfo SET "																		\
			...
			"ChaHair= %d, ChaSchool= %d, ChaLiving= %d, ChaCP=%d, SkillSlotNum=%d, ChaMagicA= %d"									\
		"WHERE ChaNum = %d "
