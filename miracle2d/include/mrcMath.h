	...
	*/
	...
	public:
		...
		*/
		...
		static inline int32 IAbs (int32 iValue) { return ( iValue >= 0 ? iValue : -iValue ); }
		static inline int32 ICeil (float fValue) { return int(ceil(fValue)); }
		static inline int32 IFloor (float fValue) { return int(floor(fValue)); }
		static int32 ISign (int32 iValue);
...
//		static bool intersects(const Sphere& sphere, const Plane& plane);
		...
		*/
		...
		{
			mrcASSERT (minval < maxval && "Invalid clamp range");
