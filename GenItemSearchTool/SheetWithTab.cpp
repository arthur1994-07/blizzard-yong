...
std::string g_strEditSheet[PAGE_NSIZE] =
{
	"Edit_MapsList",
	"Search_GenItem",
};
	 ...
	 , m_pFont(NULL)
{
	...
	m_MapsListPage.SetSheetTab(this);
...
void CsheetWithTab::SetPage( int nPage )
{
	...
	{
	case PAGE_MAPS_LIST:
		return m_MapsListPage.Init();
	case PAGE_GEN_ITEM_SEARCH:
		return m_GenItemSearchPage.Init();
	}
}
...
bool CsheetWithTab::NewFile( int nPage )
{
	...
	{
	case PAGE_MAPS_LIST:
		return m_MapsListPage.NewFile();
	case PAGE_GEN_ITEM_SEARCH:
		return m_GenItemSearchPage.NewFile();
	}
...
bool CsheetWithTab::LoadFile( int nPage )
{
	...
	{
	case PAGE_MAPS_LIST:
		return m_MapsListPage.LoadFile();
	case PAGE_GEN_ITEM_SEARCH:
		return m_GenItemSearchPage.LoadFile();
	}
...
bool CsheetWithTab::LoadFileOld( int nPage )
{
	...
	{
	case PAGE_MAPS_LIST:
		return m_MapsListPage.LoadFileOld();
	case PAGE_GEN_ITEM_SEARCH:
		break;
	}
...
bool CsheetWithTab::SaveFile( int nPage )
{
	...
	{
	case PAGE_MAPS_LIST:
		return m_MapsListPage.SaveFile();
	case PAGE_GEN_ITEM_SEARCH:
		return m_GenItemSearchPage.SaveFile();
	}
...
bool CsheetWithTab::CsvLoad( int nPage )
{
	...
	{
	case PAGE_MAPS_LIST:
		return m_MapsListPage.LoadCsv();
	case PAGE_GEN_ITEM_SEARCH:
		return m_GenItemSearchPage.LoadCsv();
	}
...
bool CsheetWithTab::CsvSave( int nPage )
{
	...
	{
	case PAGE_MAPS_LIST:
		return m_MapsListPage.SaveCsv();
	case PAGE_GEN_ITEM_SEARCH:
		return m_GenItemSearchPage.SaveCsv();
	}
