...
public:
    ...
    enum	{	BTNST_PRESSED_LEFTRIGHT = 0,	// Pressed style from left to right (as usual)
				BTNST_PRESSED_TOPBOTTOM	= 1,	// Pressed style from top to bottom
				BTNST_NONPRESS = 2,
			};

	enum	{	CONTROL_IMAGE_IN = 0,
				CONTROL_IMAGE_OUT = 1,
				CONTROL_IMAGE_PRESS = 2,
				CONTROL_IMAGE_DIS = 3,
				CONTROL_IMAGE_SIZE = 4,
			};
...
public:
	...
	DWORD SetIcon(int nIconIn, int nCxDesiredIn, int nCyDesiredIn, 
				  ...
				  int nIconDown = NULL, int nCxDesiredDown = 0, int nCyDesiredDown = 0,
				  int nIconDis = NULL, int nCxDesiredDis = 0, int nCyDesiredDis = 0 );
	DWORD SetIcon(int nIconIn, int nIconOut, int nIconDown = NULL, int nIconDis= NULL );
	DWORD SetIcon(HICON hIconIn, HICON hIconOut = NULL, HICON hIconDown = NULL, HICON hIconDis = NULL);

	DWORD SetBitmaps(int nBitmapIn, int nBitmapOut = NULL, int nBitmapDown = NULL, int nBitmapDis = NULL );
	DWORD SetBitmaps(int nBitmapIn, COLORREF crTransColorIn, int nBitmapOut = NULL, COLORREF crTransColorOut = 0,
					 int nBitmapDown = NULL, COLORREF crTransColorDown = 0, int nBitmapDis = NULL, COLORREF crTransColorDis = 0 );
	DWORD SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0,
					 HBITMAP hBitmapDown = NULL, COLORREF crTransColorDown = 0, HBITMAP hBitmapDis = NULL, COLORREF crTransColorDis = 0 );
...
#pragma pack()
	...
	STRUCT_ICONS	m_csIcons[CONTROL_IMAGE_SIZE];
	STRUCT_BITMAPS	m_csBitmaps[CONTROL_IMAGE_SIZE];
