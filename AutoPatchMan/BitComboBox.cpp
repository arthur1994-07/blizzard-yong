...
CBitComboBox::CBitComboBox()
{
	...
	m_colTextHighLight = RGB(192,192,192);
	m_colBackGroundHighLight = RGB(115,138,174);
	m_colTextNormal = RGB(192,192,192);
	m_colBackGroundNormal = RGB(102,103,108);
}
...
void CBitComboBox::OnPaint() 
{
	...
	rcRepaint.top += 3; rcRepaint.bottom -= 7;
...
void CBitComboBox::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
	...
	{
        // V523 The 'then' statement is equivalent to the 'else' statement. bitcombobox.cpp 360
...
void CBitComboBox::SetHighlightTextColor(COLORREF colText)
{
...
void CBitComboBox::SetNormalPositionTextColor(COLORREF colText)
{
