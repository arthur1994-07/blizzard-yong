...
public:
	...
	std::tr1::shared_ptr< std::list<CMapFnInfo> > GetPublicFunctions() const;
	...
	/// Find public function info by function address.
	virtual bool FindFunctionInfo(PVOID ptrAddress, std::tr1::shared_ptr<CBaseFnInfo>& pFnInfo, DWORD64& dwDisplacement64) const;
	/// Retrieve the list of source files.
	std::tr1::shared_ptr< std::list<CMapFileData> > GetFilesList() const;
	...
	/// Find line info by line address.
	virtual bool FindLineInfo(PVOID ptrAddress, std::tr1::shared_ptr<CBaseFileInfo>& pFileInfo, std::tr1::shared_ptr<CBaseLineInfo>& pLineInfo, DWORD& dwDisplacement32) const;
	/// Get image offset.
...
private:
	...
	mutable std::tr1::shared_ptr<std::list<CMapFnInfo> > m_plstPubFns;
	/// List of source files.
	mutable std::tr1::shared_ptr<std::list<CMapFileData> > m_plstFilesList;
};
