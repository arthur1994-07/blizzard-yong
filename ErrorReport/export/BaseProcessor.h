...
public:
	...
	virtual bool FindFunctionInfo(PVOID ptrAddress, std::tr1::shared_ptr<CBaseFnInfo>& pFnInfo, DWORD64& dwDisplacement64) const = 0;
	/// Find line info by line address.
	virtual bool FindLineInfo(PVOID ptrAddress, std::tr1::shared_ptr<CBaseFileInfo>& pFileInfo, std::tr1::shared_ptr<CBaseLineInfo>& pLineInfo, DWORD& dwDisplacement32) const = 0;
};
