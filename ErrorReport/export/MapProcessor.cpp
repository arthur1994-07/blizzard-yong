 ...
 */
std::tr1::shared_ptr< std::list<CMapFnInfo> > CMapProcessor::GetPublicFunctions() const
{
...
{
	std::tr1::shared_ptr< std::list<CMapFnInfo> > plstPubFns(GetPublicFunctions());
 ...
 */
std::tr1::shared_ptr< std::list<CMapFileData> > CMapProcessor::GetFilesList() const
{
...
bool CMapProcessor::FindLineInfo(PVOID ptrAddress, CMapFileInfo& rFileInfo, CMapLineInfo& rLineInfo, DWORD& dwDisplacement32) const
{
	...
	dwDisplacement32 = 0;
	std::tr1::shared_ptr< std::list<CMapFileData> > plstFilesList(GetFilesList());
 ...
 * @return true if function info has been found.
 */
bool CMapProcessor::FindFunctionInfo(PVOID ptrAddress, std::tr1::shared_ptr<CBaseFnInfo>& pFnInfo, DWORD64& dwDisplacement64) const
{
	CMapFnInfo FnInfo;
 ...
 * @return true if line was found.
 */
bool CMapProcessor::FindLineInfo(PVOID ptrAddress, std::tr1::shared_ptr<CBaseFileInfo>& pFileInfo, std::tr1::shared_ptr<CBaseLineInfo>& pLineInfo, DWORD& dwDisplacement32) const
{
