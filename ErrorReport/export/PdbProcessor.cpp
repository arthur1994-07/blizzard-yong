 ...
 * @return true if function info has been found.
 */
bool CPdbProcessor::FindFunctionInfo(PVOID ptrAddress, std::tr1::shared_ptr<CBaseFnInfo>& pFnInfo, DWORD64& dwDisplacement64) const
{
	_ASSERTE(m_hSymProcess != NULL);
	CPdbFnInfo FnInfo;
 ...
 * @return true if line was found.
 */
bool CPdbProcessor::FindLineInfo(PVOID ptrAddress, std::tr1::shared_ptr<CBaseFileInfo>& pFileInfo, std::tr1::shared_ptr<CBaseLineInfo>& pLineInfo, DWORD& dwDisplacement32) const
{
	_ASSERTE(m_hSymProcess != NULL);
