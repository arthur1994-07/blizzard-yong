...
CVisualScriptApp theApp;

BEGIN_MESSAGE_MAP( CVisualScriptApp, CWinApp )
END_MESSAGE_MAP()

CVisualScriptApp::CVisualScriptApp()
    : m_pFrame( NULL )
    , m_hIcon( NULL )
{
    //GLogicData::GetInstance().LoadCountryFile();
    BUG_TRAP::BugTrapInstall(SP_OFFICE_TEST, TSTRING( _T( "VisualScript" ) ) );
...
BOOL CVisualScriptApp::InitInstance()
{
...
void CVisualScriptApp::OnCreateApp()
{
...
void CVisualScriptApp::OnDestroyApp()
{
}