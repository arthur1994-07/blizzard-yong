...
protected:
	...
	std::tr1::shared_ptr<SNpcTalkCondition>	m_spOrgCondition;
	SNpcTalkCondition	m_DummyCondition;
	CFont*				m_pFont;

	BOOL			m_bDlgInit;
	SITEM_NUM		m_TalkNeedItem[5];

public:
	void	SetCallPage ( int CallPage ) { m_CallPage = CallPage; }
	void	SetSheetTab ( CsheetWithTab* pSheetTab ) { m_pSheetTab = pSheetTab; }
	BOOL	SetCondition(std::tr1::shared_ptr<SNpcTalkCondition> spConditon);
...
public:
    ...
    afx_msg void OnBnClickedButtonSkillFactAdd();
    afx_msg void OnBnClickedButtonSkillFactDel();
