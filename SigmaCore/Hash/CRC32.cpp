...
// Static CRC table
DWORD HASH::s_arrdwCrc32Table[256] =
{
...
inline void CCrc32StaticW::CalcCrc32( const BYTE byte, DWORD& dwCrc32 )
{
	dwCrc32 = ((dwCrc32) >> 8) ^ s_arrdwCrc32Table[(byte) ^ ((dwCrc32) & 0x000000FF)];
}

bool CCrc32StaticW::GetFileSizeQW( const HANDLE hFile, QWORD &qwSize )
{
	_ASSERTE(hFile != INVALID_HANDLE_VALUE);
...
DWORD CCrc32StaticW::StringCrc32( const wchar_t* szString, DWORD& dwCrc32 )
{
	_ASSERTE(szString);
...
DWORD CCrc32StaticW::FileCrc32Streams( const wchar_t* szFilename, DWORD& dwCrc32 )
{
/*
#if UNICODE || _UNICODE
	return ERROR_NOT_SUPPORTED;
