package scaleform.clik.core
{
    ...
    public class UIComponent extends MovieClip
    {
        ...
        protected var _simpleTooltip:String = "";
        ...
        public function set SimpleTooltip(param1:String) : void
        {
            this._simpleTooltip = param1;
            return;
        }// end function

        public function get SimpleTooltip() : String
        {
            return this._simpleTooltip;
        }// end function
        ...
        {
            if (this._tooltipText == "" && this._simpleTooltip == "")
            {
                return;
            }
