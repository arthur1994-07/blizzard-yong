package 
{
    ...
    dynamic public class GroupChatLog extends MChatLog
    {

        public function GroupChatLog()
        {
            this.__setProp_scrollBar_GroupChatLog_scrollBar_0();
            return;
        }// end function

        function __setProp_scrollBar_GroupChatLog_scrollBar_0()
        {
            try
            {
