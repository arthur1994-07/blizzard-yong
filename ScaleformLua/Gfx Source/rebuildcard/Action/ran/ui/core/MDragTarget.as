package ran.ui.core
{
    ...
    public class MDragTarget extends DragSlot implements IGameSlot
    {
        ...
        public var ItemRootType:TextField;
        ...
        override protected function draw() : void
        {
            ...
            if (isInvalid(InvalidationType.DATA))
            {
                if (data != null && data is Object && !(data is String))
                {
                    ...
                    if (this.ItemRootType)
                    {
                        this.ItemRootType.text = data.purType != null ? (data.purType) : ("");
                        _loc_2 = this.ItemRootType.getTextFormat();
                        this.ItemRootType.setTextFormat(_loc_2);
                    }
                    if (data.iconPath != null && data.iconPath != "")
                    {
                        if (this.iconForceUpdate == true || this._lastIconPath != data.iconPath || (content as Icon).isLoading == true)
                        {
                            _loc_3 = getDefinitionByName("Icon") as Class;
                            _loc_4 = new _loc_3 as Icon;
                            this.updateIconWithData(_loc_4);
                            content = _loc_4;
                        }
                        this.LoadWrapIcon();
                        this.LoadLevelIcon();
                        ...
                        if (content)
                        {
                            ...
                            {
                                _loc_5.setTint(0, 0.5);
                            }
                            content.transform.colorTransform = _loc_5;
                            if (this.wrapIcon)
                            {
                                this.wrapIcon.transform.colorTransform = _loc_5;
                            }
                ...
                else
                {
                    if (stage != null)
                    {
                        _loc_6 = new TooltipEvent(TooltipEvent.HIDE);
                        _loc_6.elem = this;
