package MiniGame_Dice_fla
{
    ...
    dynamic public class SymbolGoldBox_4 extends MovieClip
    {
        public var __setPropDict:Dictionary;
        public var __lastFrameProp:int = -1;
        public var slot:Slot;

        public function SymbolGoldBox_4()
        {
            this.__setPropDict = new Dictionary(true);
            addFrameScript(0, this.frame1, 8, this.frame9, 18, this.frame19, 29, this.frame30, 40, this.frame41);
            addEventListener(Event.FRAME_CONSTRUCTED, this.__setProp_handler, false, 0, true);
            return;
        }// end function

        function __setProp_slot_SymbolGoldBox_Layer2_0(param1:int)
        {
            var curFrame:* = param1;
        ...
        function __setProp_slot_SymbolGoldBox_Layer2_19(param1:int)
        {
            var curFrame:* = param1;
            if (this.slot != null && curFrame >= 20 && curFrame <= 41 && (this.__setPropDict[this.slot] == undefined || !(int(this.__setPropDict[this.slot]) >= 20 && int(this.__setPropDict[this.slot]) <= 41)))
            {
                this.__setPropDict[this.slot] = curFrame;
                try
                {
        ...
        function __setProp_handler(param1:Object)
        {
            ...
            this.__setProp_slot_SymbolGoldBox_Layer2_0(_loc_2);
            this.__setProp_slot_SymbolGoldBox_Layer2_19(_loc_2);
            return;
        }// end function
