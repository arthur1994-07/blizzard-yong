package SkillQuickSlot_fla
{
    ...
    dynamic public class ColSlotMC_12 extends MovieClip
    {
        ...
        public function ColSlotMC_12()
        {
            addFrameScript(0, this.frame1);
            this.__setProp_btnRotate_ColSlotMC_asset_0();
            this.__setProp_btnShortcut_ColSlotMC_asset_0();
            return;
        }// end function

        function __setProp_btnRotate_ColSlotMC_asset_0()
        {
            try
            {
        ...
        function __setProp_btnShortcut_ColSlotMC_asset_0()
        {
            try
            {
