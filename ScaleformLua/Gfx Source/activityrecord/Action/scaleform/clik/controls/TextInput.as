package scaleform.clik.controls
{
    ...
    public class TextInput extends UIComponent
    {
        ...
        protected var _currencyUnit:Boolean = false;
        ...
        {
            if (this._textFormat.align == param1)
            {
                return;
            }
            ...
            {
                this.defaultTextFormat.align = this._textFormat.align;
            }
            invalidateData();
            return;
        }// end function
        ...
        public function get text() : String
        {
            var _loc_1:* = null;
            var _loc_2:* = null;
            if (this.currencyUnit == true)
            {
                _loc_1 = /,/gi;
                _loc_2 = this._text;
                _loc_2 = _loc_2.replace(_loc_1, "");
                return _loc_2;
            }
            return this._text;
        }// end function
        ...
        public function get currencyUnit() : Boolean
        {
        ...
        public function set targetText(param1:String) : void
        {
            this._targetText = param1;
            return;
        }// end function

        public function get targetText() : String
        {
            return this._targetText;
        }// end function

        public function set targetTextByte(param1:int) : void
        {
            return;
        }// end function

        public function get targetTextByte() : int
        {
            return this.GetTextByteTarget(this._targetText);
        }// end function
        ...
        public function set currencyUnit(param1:Boolean) : void
        {
            this._currencyUnit = param1;
            this.OnlyNumber = param1;
            return;
        }// end function
            ...
            if (_loc_2.value == InputValue.KEY_DOWN || _loc_2.value == InputValue.KEY_HOLD)
            {
                if (this.currencyUnit == true)
                {
                    switch(event.keyCode)
                    {
                        ...
                        {
                            if (this.textField.text.charAt((this.textField.caretIndex - 1)) == ",")
                            {
                                this.textField.setSelection((this.textField.caretIndex - 1), (this.textField.caretIndex - 1));
                            }
                            break;
                        }
                        case Keyboard.DELETE:
                        {
                            if (this.textField.text.charAt(this.textField.caretIndex) == ",")
                            {
                                this.textField.setSelection((this.textField.caretIndex + 1), (this.textField.caretIndex + 1));
                            }
                            break;
        ...
        override protected function configUI() : void
        {
            ...
            addEventListener(InputEvent.INPUT, this.handleInput, true, 0, true);
        ...
        protected function updateTextField() : void
        {
            ...
            this.textField.addEventListener(FocusEvent.FOCUS_OUT, this.handleTextFieldFocusOut, false, 0, true);
            this.textField.addEventListener(KeyboardEvent.KEY_UP, this.handleKeyUp, false, 0, true);
            return;
        }// end function

        protected function handleKeyUp(event:Event) : void
        {
            if (this._maxByte != 0)
            {
                if (this.GetTextByte() + this.GetTextByteTarget(DataAdapter.GetCompositionString()) > this._maxByte)
                {
                    DataAdapter.SetCompositionString("");
                }
            }
            return;
        }// end function
        ...
        {
            if (this._usingDefaultTextFormat == true)
            {
            ...
            TextFieldEx.setIMEEnabled(this.textField, this.Restrict == "all" ? (true) : (false));
            TextFieldEx.setSelectionBkgColor(this.textField, 4294967295);
            TextFieldEx.setSelectionTextColor(this.textField, 4278190080);
            return;
        }// end function
        ...
        protected function handleTextChange(event:Event) : void
        {
            ...
            if (this.currencyUnit == true)
            {
                _loc_2 = this._isHtml ? (this.textField.htmlText) : (this.textField.text);
                _loc_3 = this.textField.caretIndex;
                _loc_4 = 0;
                _loc_5 = 0;
                while (_loc_5 < this.textField.caretIndex)
                {
                ...
                _loc_6 = /,/gi;
                _loc_2 = _loc_2.replace(_loc_6, "");
                _loc_7 = _loc_2.split("");
                _loc_8 = 0;
                _loc_9 = _loc_7.length - 3;
                while (_loc_9 > 0)
                {
                    
                    _loc_7[_loc_9] = "," + _loc_7[_loc_9];
                    if (_loc_9 <= _loc_3)
                    {
                        _loc_8++;
                    }
                ...
                this.text = _loc_7.join("");
                this.textField.text = _loc_7.join("");
                this.textField.setSelection(_loc_3 + _loc_8, _loc_3 + _loc_8);
            }
            else
            {
        ...
        protected function GetTextByteTarget(param1:String) : uint
        {
            var _loc_4:* = 0;
            var _loc_2:* = 0;
            var _loc_3:* = 0;
