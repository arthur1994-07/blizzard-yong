package scaleform.clik.controls
{
    ...
    public class DragSlot extends UIComponent implements IDragSlot
    {
        ...
        protected function handleMouseDown(param1:MouseEventEx) : void
        {
        ...
        protected function handleMouseMove(param1:MouseEventEx) : void
        {
            var _loc_2:* = null;
            if (mouseX > this._mouseDownX + 3 || mouseX < this._mouseDownX - 3 || mouseY > this._mouseDownY + 3 || mouseY < this._mouseDownY - 3)
            {
                ...
                this.handleDragStartEvent(_loc_2, 0.5);
            }
            return;
        }// end function
        ...
        public function handleDragStartEvent(event:DragEvent, param2:Number) : void
        {
            return;
        }// end function
