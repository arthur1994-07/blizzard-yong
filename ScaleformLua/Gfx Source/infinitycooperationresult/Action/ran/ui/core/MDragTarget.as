package ran.ui.core
{
    ...
    public class MDragTarget extends DragSlot implements IGameSlot
    {
        ...
        protected var _lastMID:uint = 4.29497e+009;
        protected var _lastSID:uint = 4.29497e+009;
        ...
        public function get header() : String
        {
            if (data)
            {
                return DataAdapter.getSlotHeader(this._binding);
            }
            return null;
        }// end function

        public function get trade() : String
        {
            if (data)
            {
                return DataAdapter.getSlotTrade(this._binding);
            }
            return null;
        }// end function
        ...
        public function ShowTooltipSlot(param1:String) : void
        {
            if (data)
            {
                DataAdapter.showTooltipSlot(this._binding, param1);
            }
            return;
        }// end function
        ...
        override public function handleDragStartEvent(event:DragEvent) : void
        {
            var _loc_2:* = null;
            var _loc_3:* = null;
            var _loc_4:* = null;
            ...
            if (data is Object && !(data is String) && data.iconPath && data.iconPath != "")
            {
                ...
                _loc_3.transform.colorTransform = _loc_4;
                this._dragIconGhost = _loc_3;
        ...
        override protected function draw() : void
        {
            ...
            if (isInvalid(InvalidationType.DATA))
            {
                if (data != null && data is Object && !(data is String))
                {
                    ...
                    {
                        if (data.iconPath != this._lastIconPath || this._lastMID != data.MID || this._lastSID != data.SID)
                        {
                            _loc_2 = getDefinitionByName("Icon") as Class;
                            _loc_3 = new _loc_2 as Icon;
                    ...
                    this._lastMID = data.MID;
                    this._lastSID = data.SID;
                ...
                else
                {
                    ...
                    this._lastMID = 4294967295;
                    this._lastSID = 4294967295;
                }
            }
            return;
        }// end function
        ...
        protected function updateIconWithData(param1:Icon) : void
        {
            ...
            {
                param1.loadImage(data.iconPath != null ? (data.iconPath) : (""), data.MID, data.SID);
            }
            return;
        }// end function
