package Vehicle_fla
{
    ...
    dynamic public class mcCar_7 extends MovieClip
    {
        ...
        public function mcCar_7()
        {
            addFrameScript(0, this.frame1);
            this.__setProp_labelSpeed_mcCar_label_0();
            this.__setProp_labelAbility_mcCar_label_0();
            return;
        }// end function

        function __setProp_labelSpeed_mcCar_label_0()
        {
            try
            {
        ...
        function __setProp_labelAbility_mcCar_label_0()
        {
            try
            {
