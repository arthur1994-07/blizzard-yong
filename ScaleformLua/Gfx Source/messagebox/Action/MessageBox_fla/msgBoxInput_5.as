package MessageBox_fla
{
    ...
    dynamic public class msgBoxInput_5 extends MovieClip
    {
        public var btnOK:Button;
        public var btnCancel:Button;
        public var input:TextInput;

        public function msgBoxInput_5()
        {
            addFrameScript(0, this.frame1);
            this.__setProp_btnOK_msgBoxInput_MsgBox_0();
            this.__setProp_btnCancel_msgBoxInput_MsgBox_0();
            return;
        }// end function

        function __setProp_btnOK_msgBoxInput_MsgBox_0()
        {
            try
            {
        ...
        function __setProp_btnCancel_msgBoxInput_MsgBox_0()
        {
            try
            {
