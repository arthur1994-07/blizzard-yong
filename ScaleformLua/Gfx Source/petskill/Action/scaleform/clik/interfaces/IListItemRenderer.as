package scaleform.clik.interfaces
{
    ...
    public interface IListItemRenderer extends IUIComponent
    {
        ...
        function setLabelOffsetX(param1:int) : void;

        function getLeafDataProvider() : DataProvider;

        function get expanded() : Boolean;

        function set expanded(param1:Boolean) : void;

        function get checked() : Boolean;

        function set checked(param1:Boolean) : void;
