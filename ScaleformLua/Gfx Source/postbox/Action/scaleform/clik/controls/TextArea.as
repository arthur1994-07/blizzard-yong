    ...
    public class TextArea extends TextInput
    {
        ...
        override public function handleInput(event:InputEvent) : void
        {
            ...
            switch(_loc_2)
            {
                ...
                {
                    _loc_3 = textField.bottomScrollV - textField.scrollV;
                    this.position = Math.max(1, this.position - _loc_3);
                    event.handled = true;
                    break;
                }
                case NavigationCode.PAGE_DOWN:
                {
                    _loc_4 = textField.bottomScrollV - textField.scrollV;
                    this.position = Math.min(this._maxScroll, this.position + _loc_4);
                    event.handled = true;
                    break;
                }
                default:
            ...
            if (this._scrollBarValue is String)
            {
                ...
                if (_loc_1 == null)
                {
                    ...
                    if (_loc_1)
                    {
                        ...
                        if (_loc_4 && this._thumbOffset)
                        {
                            _loc_4.offsetTop = this._thumbOffset.top;
                            _loc_4.offsetBottom = this._thumbOffset.bottom;
                        }
                        _loc_1.addEventListener(MouseEvent.MOUSE_WHEEL, this.blockMouseWheel, false, 0, true);
                        (_loc_4).minThumbSize = this._minThumbSize;
