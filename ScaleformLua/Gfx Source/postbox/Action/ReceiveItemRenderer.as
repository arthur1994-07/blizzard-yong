package 
{
    ...
    dynamic public class ReceiveItemRenderer extends ListItemRenderer
    {
        public var slot:Slot;

        public function ReceiveItemRenderer()
        {
            ...
            this.__setProp_slot_ReceiveItemRenderer_slot_0();
            return;
        }// end function

        function __setProp_slot_ReceiveItemRenderer_slot_0()
        {
            try
            {
            ...
            this.slot.overlayImg = "receiveItemImage";
