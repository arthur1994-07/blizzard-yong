                    ...
                    if (this.autoSizeEnable == false)
                    {
                        ...
                        if (_loc_1 < this.textField.textWidth)
                        {
                            ...
                            while (_loc_2 < _loc_4.length)
                            {
                                ...
                                {
                                    _loc_6 = _loc_4.length - _loc_2;
                                    _loc_7 = TooltipHtmlText.substring(_loc_6, _loc_5);
                                    _loc_8 = this._text.lastIndexOf(_loc_7);
                                    _loc_9 = this._text.substring(0, _loc_8);
                                    _loc_9 = _loc_9 + this._text.substring(_loc_8 + _loc_7.length);
                                    _loc_9 = _loc_9 + "...";
                                    this.textField.htmlText = _loc_9;
                                    break;
                                }
                                _loc_2++;
                            }
