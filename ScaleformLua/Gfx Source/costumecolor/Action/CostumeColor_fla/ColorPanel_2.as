package CostumeColor_fla
{
    import flash.display.*;
    import ran.ui.core.*;
    import scaleform.clik.controls.*;

    dynamic public class ColorPanel_2 extends MovieClip
    {
        public var colorPicker:MColorPicker;
        public var btnOK:Button;
        public var btnCancel:Button;

        public function ColorPanel_2()
        {
            addFrameScript(0, this.frame1);
            this.__setProp_btnOK_ColorPanel_asset_0();
            this.__setProp_btnCancel_ColorPanel_asset_0();
            return;
        }// end function

        function __setProp_btnOK_ColorPanel_asset_0()
        {
            try
            {
        ...
        function __setProp_btnCancel_ColorPanel_asset_0()
        {
            try
            {
