package ran.ui.slot
{
    ...
    public class Slot extends MDragTarget implements IListItemRenderer
    {
        ...
        override protected function configUI() : void
        {
            ...
            if (this.mcEquip != null)
            {
                InteractiveObjectEx.setHitTestDisable(this.mcEquip, true);
                this.mcEquip.visible = false;
            }
            if (this.mcState != null)
            {
                InteractiveObjectEx.setHitTestDisable(this.mcState, true);
        ...
        protected function SetEquip() : void
        {
            if (this.mcEquip == null)
            {
                return;
            }
            if (data == null || data.bEquip == false)
            {
                this.mcEquip.visible = false;
            }
            else
            {
                this.mcEquip.visible = true;
            }
            return;
        }// end function

        protected function SetUsingPet() : void
        {
            if (this.mcState == null)
            {
                return;
            }
            if (data == null || data.bShowActivePet == false)
            {
                this.mcState.visible = false;
            }
            else
