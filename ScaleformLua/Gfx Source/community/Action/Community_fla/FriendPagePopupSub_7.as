package Community_fla
{
    ...
    dynamic public class FriendPagePopupSub_7 extends MovieClip
    {
        ...
        public function FriendPagePopupSub_7()
        {
            addFrameScript(0, this.frame1);
            this.__setProp_list_FriendPagePopupSub_list_0();
            return;
        }// end function

        function __setProp_list_FriendPagePopupSub_list_0()
        {
            try
            {
