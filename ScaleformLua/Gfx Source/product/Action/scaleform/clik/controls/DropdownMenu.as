package scaleform.clik.controls
{
    ...
    public class DropdownMenu extends Button
    {
        ...
        protected var _maxRowCount:Number = 5;
        ...
        public function set dataProvider(param1:IDataProvider) : void
        {
            ...
            if (!this.menuRowsFixed && _loc_2 > 0)
            {
                this.menuRowCount = _loc_2;
            }
            if (!this.menuRowsFixed && this.menuRowCount > this._maxRowCount)
            {
                this.menuRowCount = this._maxRowCount;
            }
            if (this._dataProvider == null)
            {
                return;
        ...
        override public function updateText() : void
        {
            ...
            if (_label != null && textField != null)
            {
                ...
                _loc_1 = this._originalWidth - this.scale9Grid.width;
                _loc_2 = this.width - _loc_1;
                if (_loc_2 < textField.textWidth)
                {
                    _loc_3 = textField.text;
                    TooltipHtmlText = _loc_3;
                    _loc_4 = 0;
                    while (_loc_4 < _loc_3.length)
                    {
                        
                        textField.text = _loc_3.substr(0, _loc_3.length - _loc_4) + "...";
