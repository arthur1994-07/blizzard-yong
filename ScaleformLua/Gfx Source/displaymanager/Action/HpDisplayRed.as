package 
{
    ...
    dynamic public class HpDisplayRed extends MovieClip
    {
        public var textField:TextField;
        public var barHP:StatusIndicator;

        public function HpDisplayRed()
        {
            addFrameScript(0, this.frame1);
            this.__setProp_barHP_HpDisplayRed_hp_0();
            return;
        }// end function

        function __setProp_barHP_HpDisplayRed_hp_0()
        {
            try
            {
