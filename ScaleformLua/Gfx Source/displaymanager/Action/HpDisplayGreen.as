package 
{
    ...
    dynamic public class HpDisplayGreen extends MovieClip
    {
        public var textField:TextField;
        public var barHP:StatusIndicator;

        public function HpDisplayGreen()
        {
            addFrameScript(0, this.frame1);
            this.__setProp_barHP_HpDisplayGreen_Layer1_0();
            return;
        }// end function

        function __setProp_barHP_HpDisplayGreen_Layer1_0()
        {
            try
            {
