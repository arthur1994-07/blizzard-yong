package scaleform.clik.controls
{
    ...
    public class ScrollingList extends CoreList
    {
        ...
        public function getTreeButton(param1:int) : MovieClip
        {
            if (param1 >= this._treeButtons.length)
            {
                return null;
            }
            return this._treeButtons[param1];
        }// end function

        public function getTreeCheckBox(param1:int) : MovieClip
        {
            if (param1 >= this._treeCheckBoxes.length)
            {
                return null;
            }
            return this._treeCheckBoxes[param1];
        }// end function
