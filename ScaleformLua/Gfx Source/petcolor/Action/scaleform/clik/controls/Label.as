package scaleform.clik.controls
{
    ...
    public class Label extends UIComponent
    {
        ...
        protected function calculateWidth() : Number
        {
            ...
            var _loc_1:* = Math.ceil(this.textField.textWidth + _loc_2.left + _loc_2.right + 5);
            return _loc_1;
        }// end function
        ...
        override public function updateText() : void
        {
            ...
            if (this._text != null && this.textField != null)
            {
                if (this.isHtml)
                {
                    ...
                    if (this.autoSize == TextFieldAutoSize.NONE)
                    {
                        if (this.width < this.textField.textWidth)
                        {
                    ...
                    if (this.autoSize == TextFieldAutoSize.NONE)
                    {
                        if (this.width < this.textField.textWidth)
                        {
                            ...
                            while (_loc_1 < this.textField.length)
                            {
                                ...
                                if (this.width < this.textField.getCharBoundaries(_loc_1).x + this.textField.getCharBoundaries(_loc_1).width)
                                {
