    ...
    public class Slot extends MDragTarget implements IListItemRenderer
    {
        ...
        override protected function draw() : void
        {
            ...
            if (isInvalid(InvalidationType.DATA) == true)
            {
                ...
                {
                    if (mouseX >= 0 && this.scaleX * this.width > mouseX && mouseY >= 0 && this.scaleY * this.height > mouseY)
                    {
                        _loc_1 = true;
                        _loc_2 = this.parent;
                        while (true)
                        ...
                        if (_loc_1 == true)
                        {
                            _loc_3 = new MouseEvent(MouseEvent.ROLL_OVER, true, false, mouseX, mouseY);
