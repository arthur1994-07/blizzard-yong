package BattleLoyalRankingInfo_fla
{
    import flash.display.*;
    import ran.ui.slot.*;
    import scaleform.clik.controls.*;

    dynamic public class mcReward_2 extends MovieClip
    {
        ...
        public function mcReward_2()
        {
            addFrameScript(0, this.frame1);
            this.__setProp_label_mcReward_asset_0();
            return;
        }// end function

        function __setProp_label_mcReward_asset_0()
        {
            try
            {
            ...
            this.label.autoSizeEnable = false;
