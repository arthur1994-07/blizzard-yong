package scaleform.clik.controls
{
    ...
    public class ScrollIndicator extends UIComponent implements IScrollBar
    {
        ...
        public function set position(param1:Number) : void
        {
            ...
            var _loc_2:* = this._position;
            this._position = param1;
            dispatchEventAndSound(new Event(Event.SCROLL));
            invalidateData();
            _loc_2 = this._position - _loc_2;
            if (this.scrollTarget != null)
            {
                this.scrollTarget.dispatchEvent(new ScrollEvent(ScrollEvent.SCROLL_EVENT, false, true, _loc_2));
            }
            return;
        }// end function
        ...
        override public function handleInput(event:InputEvent) : void
        {
            ...
            event.handled = true;
            _loc_4 = this.position - _loc_4;
            if (this.scrollTarget != null)
            {
                this.scrollTarget.dispatchEvent(new ScrollEvent(ScrollEvent.SCROLL_EVENT, false, true, _loc_4));
            }
            return;
        }// end function
        ...
        protected function handleTargetScroll(event:Event) : void
        {
            ...
            if (_loc_2 != null)
            {
                ...
                _loc_3 = this.position;
                this.position = _loc_2.scrollV;
                _loc_3 = this.position - _loc_3;
                if (this.scrollTarget != null)
                {
                    this.scrollTarget.dispatchEvent(new ScrollEvent(ScrollEvent.SCROLL_EVENT, false, true, _loc_3));
                }
            }
            return;
        }// end function
