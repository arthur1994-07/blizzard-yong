package ran.ui.utils
{
    ...
    public class SubItemTooltip extends BaseTooltipUnit
    {

        public function SubItemTooltip()
        {
            _tooltipType = BaseTooltipUnit.ITEM_SUB_TOOLTIP;
            return;
        }// end function
        ...
        override protected function ConstructTooltip(param1:Object) : void
        {
            ...
            if (_tooltipRef == null)
            {
                _loc_23 = getDefinitionByName(tooltipClassName) as Class;
                if (_loc_23 == null)
                {
                    return;
                }
                _tooltipRef = new _loc_23 as MovieClip;
            }
            ...
            DataAdapter.showTooltipSlot_byID(param1["itemid"] as int, SLOT_BINDING, _tooltipType as int);
            if (_loc_12.visible == true)
            {
                _loc_24 = _loc_12.y + _loc_12.height;
                _loc_13.y = _loc_24;
                _loc_6.y = _loc_24;
            }
            ...
            while (_loc_22 <= TRADE_SLOT_COUNT)
            {
                ...
                _loc_26 = "TradeSlot" + _loc_22;
                _loc_13 = _tooltipRef[_loc_26];
                _loc_13.visible = false;
                _loc_22++;
            }
            return;
