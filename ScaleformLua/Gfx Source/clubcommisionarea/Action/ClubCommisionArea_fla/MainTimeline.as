package ClubCommisionArea_fla
{
    ...
    {
        public var labelCommision:Label;
        public var comboArea:DropdownMenu;
        ...
        public function MainTimeline()
        {
            ...
            this.__setProp_comboArea_Scene1_asset_0();
            this.__setProp_list_Scene1_asset_0();
            this.__setProp_scrollBar_Scene1_asset_0();
            this.__setProp_item1_Scene1_asset_0();
            this.__setProp_item2_Scene1_asset_0();
            this.__setProp_item3_Scene1_asset_0();
            this.__setProp_item4_Scene1_asset_0();
            this.__setProp_item5_Scene1_asset_0();
            this.__setProp_item6_Scene1_asset_0();
            this.__setProp_item7_Scene1_asset_0();
            this.__setProp_item8_Scene1_asset_0();
            this.__setProp_item9_Scene1_asset_0();
            return;
        }// end function

        function __setProp_comboArea_Scene1_asset_0()
        {
            try
            {
                this.comboArea["componentInspectorSetting"] = true;
            }
            catch (e:Error)
            {
            }
            this.comboArea.autoSize = "none";
            this.comboArea.dropdown = "DefaultScrollingList";
            this.comboArea.enabled = true;
            this.comboArea.focusable = false;
            this.comboArea.groupName = "";
            this.comboArea.itemRenderer = "ListItemRenderer_h18";
            this.comboArea.menuDirection = "down";
            this.comboArea.menuMargin = 1;
            this.comboArea.inspectableMenuOffset = {top:0, right:0, bottom:0, left:0};
            this.comboArea.inspectableMenuPadding = {top:0, right:0, bottom:0, left:0};
            this.comboArea.menuRowCount = 5;
            this.comboArea.menuRowsFixed = true;
            this.comboArea.menuWidth = -1;
            this.comboArea.menuWrapping = "normal";
            this.comboArea.overlayAlign = "none";
            this.comboArea.overlayImg = "";
            this.comboArea.overlayPadding = {x:0, y:0};
            this.comboArea.preventAutoSize = false;
            this.comboArea.scrollBar = "DefaultScrollBar";
            this.comboArea.inspectableThumbOffset = {top:0, bottom:0};
            this.comboArea.visible = true;
            try
            {
                this.comboArea["componentInspectorSetting"] = false;
            }
            catch (e:Error)
            {
            }
        ...
        function __setProp_item1_Scene1_asset_0()
        {
            try
            {
        ...
        function __setProp_item2_Scene1_asset_0()
        {
            try
            {
        ...
        function __setProp_item3_Scene1_asset_0()
        {
            try
            {
        ...
        function __setProp_item4_Scene1_asset_0()
        {
            try
            {
        ...
        function __setProp_item5_Scene1_asset_0()
        {
            try
            {
        ...
        function __setProp_item6_Scene1_asset_0()
        {
            try
            {
        ...
        function __setProp_item7_Scene1_asset_0()
        {
            try
            {
        ...
        function __setProp_item8_Scene1_asset_0()
        {
            try
            {
        ...
        function __setProp_item9_Scene1_asset_0()
        {
            try
            {
