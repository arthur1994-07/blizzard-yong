    ...
    public class MDragTarget extends DragSlot implements IGameSlot
    {
        ...
        override protected function draw() : void
        {
            ...
            if (isInvalid(InvalidationType.DATA))
            {
                ...
                {
                    _loc_1 = DragManager.GetDragOriginTarget() as Slot;
                    if (_loc_1 != null && _loc_1.binding == this.binding)
                    {
                        _loc_2 = DragManager.GetDragTarget() as IDragSlot;
                        if (_loc_2 != null)
                        {
                            _loc_2.data = data;
                        }
                    ...
                    if (this.valueAmount)
                    {
                        ...
                        _loc_3 = this.valueAmount.getTextFormat();
                        _loc_3.color = data.dwCountColor;
                        this.valueAmount.setTextFormat(_loc_3);
                    }
                    if (data.iconPath != null && data.iconPath != "")
                    {
                        ...
                        {
                            _loc_4 = getDefinitionByName("Icon") as Class;
                            _loc_5 = new _loc_4 as Icon;
                            this.updateIconWithData(_loc_5);
                            content = _loc_5;
                        }
                        this.LoadWrapIcon();
                        this.LoadOPIcon();
                        if (content)
                        {
                            ...
                            {
                                _loc_6.setTint(0, 0.5);
                            }
                            content.transform.colorTransform = _loc_6;
                            if (this.wrapIcon)
                            {
                                this.wrapIcon.transform.colorTransform = _loc_6;
                            }
                        }
                    }
                ...
                else
                {
                    if (stage != null)
                    {
                        _loc_7 = new TooltipEvent(TooltipEvent.HIDE);
                        _loc_7.elem = this;
                        stage.dispatchEvent(_loc_7);
                    }
                    if (this.valueAmount)
                    {
                        this.valueAmount.text = "";
