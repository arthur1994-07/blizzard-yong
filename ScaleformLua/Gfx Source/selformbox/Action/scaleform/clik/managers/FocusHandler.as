package scaleform.clik.managers
{
    ...
    public class FocusHandler extends Object
    {
        ...
        public function setFocus(param1:InteractiveObject, param2:uint = 0, param3:Boolean = false) : void
        {
            ...
            if (param1 as Sprite && param3 && _loc_6.tabEnabled == false)
            {
                param1 = null;
            }
            ...
            if (this.getCurrentFocusDisplayObject(param2) != param1)
            {
                ...
                if (_loc_8 != null)
                {
                    if (_loc_8 is UIComponent)
                    {
                        (_loc_5).dispatchEventAndSound(new FocusHandlerEvent(FocusHandlerEvent.FOCUS_OUT, true, false, param2));
                    }
                    else
                    {
                ...
                if (_loc_8 != null)
                {
                    if (_loc_8 is UIComponent)
                    {
                        (_loc_5).dispatchEventAndSound(new FocusHandlerEvent(FocusHandlerEvent.FOCUS_IN, true, false, param2));
                    }
                    else
                    {
        ...
        protected function handleInput(event:InputEvent) : void
        {
            ...
            if (this.getCurrentFocusDisplayObject(_loc_3) == null)
            {
                _loc_4 = this._stage;
            }
            ...
            {
                _loc_6 = (_loc_4 as UIComponent).dispatchEventAndSound(_loc_5);
            }
            else
            {
                _loc_6 = _loc_4.dispatchEvent(_loc_5);
            }
            ...
            if (event.details.navEquivalent == null)
            {
                return;
            }
            ...
            if (FocusManager.findFocus(_loc_7, null, _loc_14 == FocusMode.LOOP, _loc_8, false, _loc_2) != null)
            {
        ...
        protected function handleFocusChange(param1:InteractiveObject, param2:InteractiveObject, param3:FocusEvent) : void
        {
            ...
            var _loc_5:* = param3 as FocusEventEx == null ? (0) : (_loc_4.controllerIdx);
        ...
        protected function updateActualFocus(event:FocusEvent) : void
        {
            ...
            var _loc_5:* = event as FocusEventEx == null ? (0) : (_loc_4.controllerIdx);
            var _loc_6:* = FocusManager.getControllerFocusGroup(_loc_5);
