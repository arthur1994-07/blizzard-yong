package scaleform.clik.core
{
    ...
    public class UIComponent extends MovieClip
    {
        ...
        protected var _BlankTimer:Timer;
        protected var _BlankData:Object;
        public var _tween:Tween;
        protected var _tooltipText:String = "";
        protected var _isHtmlTooltipText:Boolean = false;
        protected var _tooltipEnabled:Boolean = true;
        protected var _keepSlot:Boolean = false;
        ...
        public function UIComponent()
        {
            ...
            addEventListener(Event.REMOVED_FROM_STAGE, this.removeToStage, false, 0, true);
            addEventListener(MouseEvent.ROLL_OVER, this.onRollOverTooltip, false, 0, true);
            addEventListener(MouseEvent.ROLL_OUT, this.onRollOutTooltip, false, 0, true);
            return;
        }// end function
        ...
        public function set TooltipHtmlText(param1:String) : void
        {
            if (param1 == "" && this._isHtmlTooltipText == false)
            {
                return;
            }
            this._tooltipText = param1;
            this._isHtmlTooltipText = this._tooltipText.length != 0;
            return;
        }// end function

        public function get TooltipHtmlText() : String
        {
            return this._tooltipText;
        }// end function
        ...
        public function set TooltipEnabled(param1:Boolean) : void
        {
            ...
            {
                removeEventListener(MouseEvent.ROLL_OVER, this.onRollOverTooltip);
                removeEventListener(MouseEvent.ROLL_OUT, this.onRollOutTooltip);
            }
            return;
        }// end function

        public function set keepSlot(param1:Boolean) : void
        {
            this._keepSlot = param1;
            return;
        }// end function

        public function get keepSlot() : Boolean
        {
            return this._keepSlot;
        }// end function

        protected function removeToStage(event:Event) : void
        {
            var _loc_2:* = null;
            if (this._tween != null)
            {
        ...
        protected function onRollOverTooltip(event:MouseEvent) : void
        {
        ...
        protected function onRollOutTooltip(event:MouseEvent) : void
        {
            if (stage == null)
            {
                return;
        ...
        override public function set enabled(param1:Boolean) : void
        {
            ...
            while (_loc_2 < numChildren)
            {
                ...
                _loc_3 = getChildAt(_loc_2) as MovieClip;
                if (_loc_3 != null && _loc_3.hasOwnProperty("enabled") == true)
                {
        ...
        protected function getInvalid() : String
        {
            ...
            while (_loc_3 < _loc_2.length)
            {
                ...
                _loc_1.push("* " + _loc_2[_loc_3] + ": " + (this._invalidHash[_loc_2[_loc_3]] == true));
                _loc_3 = _loc_3 + 1;
            }
        ...
        public function set blink(param1:Object) : void
        {
            var _loc_4:* = 0;
            var _loc_2:* = null;
            if (this._BlankData != null && this._BlankData["target"] != null)
            {
                _loc_2 = this._BlankData["target"];
            }
            this._BlankData = param1;
            var _loc_3:* = this._BlankData["use"];
            if (_loc_3 == true)
            {
                _loc_4 = param1["FPS"];
                this._BlankTimer = new Timer(1000 / _loc_4, 0);
                this._BlankTimer.addEventListener(TimerEvent.TIMER, this.onBlinkRepeat, false, 0, true);
                this._BlankTimer.start();
            }
            else if (_loc_3 == false)
            {
                this._BlankTimer.stop();
                this._BlankTimer.reset();
                this._BlankTimer.removeEventListener(TimerEvent.TIMER, this.onBlinkRepeat);
        ...
        protected function onBlinkRepeat(event:TimerEvent) : void
        {
            var _loc_2:* = 0;
            var _loc_3:* = this._BlankData["inst"].split(".");
            var _loc_4:* = this;
            _loc_2 = 0;
            while (_loc_2 < _loc_3.length)
            {
                
                _loc_4 = _loc_4.getChildByName(_loc_3[_loc_2]) as MovieClip;
                if (_loc_4 == null)
                {
                    trace("obj is undefined and null");
                    return;
                }
                _loc_2++;
            }
            this._BlankData["target"] = _loc_4;
