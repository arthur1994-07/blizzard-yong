package scaleform.clik.controls
{
    ...
    public class Button extends UIComponent
    {
        ...
        protected var textScaleWidth:int = 0;
        protected var _everyFrameUpdate:Boolean = false;
        ...
        public function set everyFrameUpdate(param1:Boolean) : void
        {
            this._everyFrameUpdate = param1;
            if (this._everyFrameUpdate == true)
            {
                addEventListener(Event.ENTER_FRAME, this.OnUpdate, false, 0, true);
            }
            else
            {
        ...
        public function get everyFrameUpdate() : Boolean
        {
            return this._everyFrameUpdate;
        }// end function
        ...
        {
            return this.preventAutosizing;
        }// end function

        public function set preventAutoSize(param1:Boolean) : void
        {
            this.preventAutosizing = param1;
            return;
        }// end function
        ...
        override protected function configUI() : void
        {
            ...
            if (this.textField)
            {
                this.textScaleWidth = this.textField.width;
            }
            return;
        }// end function
        ...
        override public function updateText() : void
        {
            ...
            if (this._label != null && this.textField != null)
            {
                ...
                if (this.autoSize == TextFieldAutoSize.NONE)
                {
                    if (constraints.getElement("textField").clip.scaleX != 1)
                    {
                        this.textScaleWidth = this.textField.width / constraints.getElement("textField").clip.scaleX;
                    }
                    if (this.textScaleWidth < this.textField.textWidth)
                    {
                        SimpleTooltip = this.textField.text;
                        _loc_1 = 0;
                        while (_loc_1 < this.textField.length)
                        {
                            
                            if (this.textScaleWidth < this.textField.getCharBoundaries(_loc_1).x + this.textField.getCharBoundaries(_loc_1).width)
                            {
                                this.textField.text = this.textField.text.substr(0, _loc_1 - 3) + "...";
                            }
                            _loc_1++;
                        }
                    }
        ...
        {
            if (_tooltipText == "" && _simpleTooltip == "")
            {
                return;
            }
