            ...
            while (_loc_4 < _loc_3)
            {
                ...
                else if (param1.length != 0)
                {
                    ...
                    if (_loc_4 < param1.length)
                    {
                        ...
                        {
                            _loc_11 = param1[_loc_4].multiSelected;
                        }
                    }
                    _loc_7 = new ListData(_loc_6, itemToLabel(param1[_loc_4]), _loc_11);
                }
                else
                {
                    _loc_7 = new ListData(_loc_6, itemToLabel(param1[_loc_4]), _selectedIndex == _loc_6);
                ...
                _loc_5.validateNow();
                _loc_8 = this._treeButtons[_loc_4];
                _loc_9 = this._treeCheckBoxes[_loc_4];
                _loc_10 = this._treeButtonGap;
                if (_loc_10 == -1)
                {
                    if (_loc_8 != null)
                    {
                        _loc_10 = _loc_8.width;
                    }
                    else if (_loc_8 == null && _loc_9 != null)
                    {
                ...
                if (this.treeList == true && _loc_5.enabled == true)
                {
                    if (param1[_loc_4] != null)
                    {
                        _loc_12 = param1[_loc_4].leaf;
                        if (undefined == _loc_12 || _loc_12 == 0 || _loc_12.length == 0)
                        {
                            if (param1[_loc_4].likeFolder == false)
                            {
                                if (_loc_8 != null)
                                {
                                ...
                                {
                                    _loc_9.visible = true;
                                    _loc_9.selected = _loc_5.checked;
                                }
                            }
                            else
                            {
                        ...
                        else
                        {
                            ...
                            {
                                _loc_8.visible = true;
                                _loc_8.selected = _loc_5.expanded;
                            }
                            if (_loc_9 != null)
                            {
                                _loc_9.visible = false;
                        ...
                        if (_loc_9 != null && _loc_9.visible == true)
                        {
                            if (_loc_8 != null && _loc_9 == null)
                            {
                                _loc_8.x = _loc_10 * param1[_loc_4].depth;
                                _loc_5.setLabelOffsetX(_loc_8.x + _loc_8.width);
                            }
                            else if (_loc_8 == null && _loc_9 != null)
                            {
                                _loc_9.x = _loc_10 * param1[_loc_4].depth;
                                _loc_5.setLabelOffsetX(_loc_9.x + _loc_9.width);
                            }
                            else if (_loc_8 != null && _loc_9 != null)
                            {
                                if (_loc_8.visible == false)
                                {
                                    _loc_9.x = _loc_10 * param1[_loc_4].depth;
                                }
                                else
                                {
                                    _loc_8.x = _loc_10 * param1[_loc_4].depth;
                                    _loc_9.x = _loc_8.x + _loc_8.width;
                                }
                                _loc_5.setLabelOffsetX(_loc_9.x + _loc_9.width);
                            }
                            else
                            {
                                _loc_5.setLabelOffsetX(param1[_loc_4].depth * _loc_10);
                            }
                        }
                        else if (_loc_8 != null)
                        {
