...
public:
	void SetSheetTab(CsheetWithTab* pSheetTab)
    { 
...
public:
	...
	afx_msg void OnBnClickedButtonItemuse();
	afx_msg void OnBnClickedButtonItemuseDel();
	afx_msg void OnBnClickedButtonItemgrinding();
	afx_msg void OnBnClickedButtonItemgrindingDel();
	afx_msg void OnBnClickedRadioItemgrinding1();
	afx_msg void OnBnClickedRadioItemgrinding2();
	afx_msg void OnBnClickedRadioItemgrinding3();
	afx_msg void OnBnClickedRadioItemgrinding4();
	afx_msg void OnBnClickedCheckTokillplayer();
	afx_msg void OnBnClickedButtonConftingDel();
	afx_msg void OnBnClickedRadioConfting1();
	afx_msg void OnBnClickedRadioConfting2();
	afx_msg void OnBnClickedRadioConfting3();
	afx_msg void OnBnClickedRadioConfting4();
	afx_msg void OnBnClickedRadioConfting5();
	afx_msg void OnBnClickedButtonLevelUpDel();
//	afx_msg void OnEnChangeEditItemuseComment();
};
