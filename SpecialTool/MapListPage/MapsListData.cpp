...
//	ON_BN_CLICKED(IDC_CHECK_PROHIBIT_RELEASE, &CMapsListData::OnBnClickedCheckProhibitRelease)
END_MESSAGE_MAP()
...
BOOL CMapsListData::OnInitDialog()
{
	...
	SetWin_Num_float( this, IDC_EDIT_RATE_EXP_DROP, m_sMapNode.m_fRateExpDrop );
	SetWin_Num_float( this, IDC_EDIT_RATE_ITEM_DROP, m_sMapNode.m_fRateItemDrop );	
	...
	SetWin_Check ( this, IDC_CHECK_ENABLESWITCHMOB, m_sMapNode.m_bDisableSwitchMob);	
	SetWin_Check ( this, IDC_CHECK_CHANGESCHOOL, m_sMapNode.m_bChangeSchool);	
	...
	SetWin_Check ( this, IDC_CHECK_MACRO, m_sMapNode.m_bMacro);	
	SetWin_Check ( this, IDC_CHECK_PRISON, m_sMapNode.m_bPrison);
	SetWin_Check ( this, IDC_CHECK_CHANGECHARSLOT, m_sMapNode.m_bChangeCharSlot );
...
void CMapsListData::OnOK()
{
	...
	m_sMapNode.m_fRateExpDrop = GetWin_Num_float( this, IDC_EDIT_RATE_EXP_DROP );
	m_sMapNode.m_fRateItemDrop = GetWin_Num_float( this, IDC_EDIT_RATE_ITEM_DROP );
	...
	m_sMapNode.m_bDisableSwitchMob = GetWin_Check(this, IDC_CHECK_ENABLESWITCHMOB);
	m_sMapNode.m_bChangeSchool = GetWin_Check ( this, IDC_CHECK_CHANGESCHOOL );
	m_sMapNode.m_bMacro  = GetWin_Check ( this, IDC_CHECK_MACRO );
	m_sMapNode.m_bPrison = GetWin_Check ( this, IDC_CHECK_PRISON );
	m_sMapNode.m_bChangeCharSlot = GetWin_Check ( this, IDC_CHECK_CHANGECHARSLOT );
...
//void CMapsListData::OnBnClickedCheckProhibitRelease()
//{
//	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
//}
