...
public:
	CAttendanceBookWindow ( GLGaeaClient* pGaeaClient, CInnerInterface* pInterface, EngineDeviceMan* pEngineDevice );
...
public:
	...
	void UnlockUI() { m_bLockUI = false; };
	bool IsLockUI() { return m_bLockUI; };
