...
CItemBankPage::CItemBankPage(GLGaeaClient* pGaeaClient, CInnerInterface* pInterface, EngineDeviceMan* pEngineDevice)
...
const SINVENITEM* CItemBankPage::GetItem(int nPosX, int nPosY) const
{
