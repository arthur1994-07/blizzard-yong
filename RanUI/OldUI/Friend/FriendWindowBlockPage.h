...
public:
	CFriendWindowBlockPage(GLGaeaClient* pGaeaClient, CInnerInterface* pInterface, EngineDeviceMan* pEngineDevice);
...
private:
	void	LoadBlockFriend(std::tr1::shared_ptr<SFRIEND> sFriend);
