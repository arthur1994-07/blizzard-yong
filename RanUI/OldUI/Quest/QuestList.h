...
public:
	CQuestList(GLGaeaClient* pGaeaClient, EngineDeviceMan* pEngineDevice);
	virtual	~CQuestList ();
...
private:
	...
	CBasicLineBox*		m_pListLineBox; // for tutorial. by luxes.
...
public: // for tutorial. by luxes.
	CBasicLineBox*	GetListTexProg() { return m_pListLineBox; }
};