...
DoublePintType::DoublePintType(EngineDeviceMan* pEngineDevice)
: CUIGroup(pEngineDevice)
, m_bPLAY ( false )
{
}

DoublePintType::~DoublePintType ()
{
}

void DoublePintType::CreateSubControl ( CString strKeyword )
{
...
void	DoublePintType::START()
{
	RESET ();
	m_bPLAY = true;
}

void	DoublePintType::RESET()
{
	m_fPlayedTime = 0.0f;
...
void DoublePintType::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
