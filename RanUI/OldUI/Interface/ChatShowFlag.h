...
////////////////////////////////////////////////////////////////////
//	사용자 메시지 정의
const DWORD UIMSG_CHAT_NORMAL1	= UIMSG_USER1;
const DWORD UIMSG_CHAT_PRIVATE1	= UIMSG_USER2;
const DWORD UIMSG_CHAT_PARTY1	= UIMSG_USER3;
const DWORD UIMSG_CHAT_CLUB1	= UIMSG_USER4;
const DWORD UIMSG_CHAT_ALLIANCE1 = UIMSG_USER5;
const DWORD UIMSG_CHAT_SYSTEM1	= UIMSG_USER6;
...
public:
	CUIChatShowFlag(EngineDeviceMan* pEngineDevice);
