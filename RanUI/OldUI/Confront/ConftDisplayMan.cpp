...
CConftDisplayMan::CConftDisplayMan( CInnerInterface* pInterface, EngineDeviceMan* pEngineDevice )
...
MyConftDisplayMan::MyConftDisplayMan( CInnerInterface* pInterface, EngineDeviceMan* pEngineDevice )
    : CConftDisplayMan( pInterface, pEngineDevice )
{
}

void MyConftDisplayMan::CreateUIWindowAndRegisterOwnership()
{
    CConftDisplayMan::Create( CONFT_DISPLAY_MAN, "CONFT_DISPLAY_MAN", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
    CConftDisplayMan::CreateSubControl();
    CConftDisplayMan::m_pInterface->UiRegisterControl( this );
}

void MyConftDisplayMan::SetFightBegin( const int nCount )
{
    CConftDisplayMan::SetFightBegin( nCount );
}

void MyConftDisplayMan::SetFightEnd( const int nResult )
{
    CConftDisplayMan::SetFightEnd( nResult );
}