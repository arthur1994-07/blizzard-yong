...
CPetSkillImage::CPetSkillImage(GLGaeaClient* pGaeaClient, EngineDeviceMan* pEngineDevice)
...
void CPetSkillImage::SetSkillProcess ( SNATIVEID sNativeID )
{
	...
	float fCurTime = m_pGaeaClient->GetPetClient()->GetSkillDelayPercent( sNativeID );
