...
CQuestionItemDisplay::CQuestionItemDisplay(GLGaeaClient* pGaeaClient, CInnerInterface* pInterface, EngineDeviceMan* pEngineDevice)
...
void CQuestionItemDisplay::CreateSubControl ()
{
	...
	{
		m_pQI_TYPE[i] = new CQuestionItemType(m_pEngineDevice);
