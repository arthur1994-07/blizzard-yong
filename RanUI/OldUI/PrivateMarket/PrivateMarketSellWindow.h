...
public:
	CPrivateMarketSellWindow ( CInnerInterface* pInterface, EngineDeviceMan* pEngineDevice );
...
private:
	CBasicTextBox*	CreateStaticControl (const char* szControlKeyword, CD3DFontPar* pFont );
