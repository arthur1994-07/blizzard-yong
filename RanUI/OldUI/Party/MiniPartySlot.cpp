...
CMiniPartySlot::CMiniPartySlot(EngineDeviceMan* pEngineDevice)
...
CBasicTextBox* CMiniPartySlot::CreateStaticControl (const char* szControlKeyword, CD3DFontPar* pFont, D3DCOLOR dwColor, int nAlign )
{
