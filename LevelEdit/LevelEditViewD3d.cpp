...
{
    // version 0x0105 ����;
    // ����ȿ���� ���������� x�� z������ ������ y���� ����.(�� x,z��ǥ�� ���ؼ� ȿ���� �ߵ��Ǵ��� ����);
    // ���� �������� �Ҷ��� plane�̳� circle�� ������ �� ������ y���� ���Ѵ�;
    // ���� ȿ���� �������� palne,circle�� y������ ������ Ȯ���Ų ������ ����ȿ���� �ش�;
    
    // version 0x0106 ����;
    // ����ȿ���� ���������� x�� z�� y���� ������ ������ ���� y���� LevelEdit������ �������� ���ؼ��� ��� ��.(���� ȿ���� �� x,z��ǥ�� ���ؼ� ȿ���� �ߵ��Ǵ��� ����);
    // ���� ���� �����Ѵٰ��ؼ� ���� �ٸ� ������ ���� �ٸ� ����ȿ���� ��������� �ʴ´ٴ� �� �����ؾ� ��;
	...
	for( unsigned int i = 0; i < vecLandEffect.size(); i++ )
	{
		...
		case EMLANDEFFECT_CANCEL_ALLBUFF: // ������
			...
			break;
		case EMLANDEFFECT_SAFE_ZONE: // �ϴû�
...
void CLevelEditView::ActiveEditMatrix2( D3DXMATRIX* matWorld )
{
	...
	m_pDxEditmat->SetAffineMatrix ( NULL );	// 2���� ��ġ�� �ȵȴ�.
}
...
void CLevelEditView::ActiveEditMatrix ( DXAFFINEMATRIX *pAffineMatrix )
{
	...
	m_sObjectMRS.SetMatrix( NULL );		// 2���� ��ġ�� �ȵȴ�.
}
