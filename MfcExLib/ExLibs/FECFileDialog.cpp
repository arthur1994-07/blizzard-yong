...
#if  _MSC_VER == 1500
CFileDialog(bOpenFileDialog, lpszDefExt, lpszFileName, dwFlags, lpszFilter, pParentWnd,0,FALSE)	// 2008
#else if _MSC_VER == 1400
CFileDialog(bOpenFileDialog, lpszDefExt, lpszFileName, dwFlags, lpszFilter, pParentWnd,0)		// 2005
#endif
{
	Files = NULL;
	Folder = NULL;
