...
void DxBillboardLookAt ( D3DXMATRIX &matOut, const D3DXVECTOR3 *pBillboardPos, const D3DXMATRIX &matView )
{
	matOut._11 = matView._11;	matOut._21 = matView._21;	matOut._31 = matView._31;
	matOut._12 = matView._12;	matOut._22 = matView._22;	matOut._32 = matView._32;
	matOut._13 = matView._13;	matOut._23 = matView._23;	matOut._33 = matView._33;

	matOut._14 = matOut._24 = matOut._34 = 0.f;
	matOut._44 = 1.f;
	...
	matOut._41 = pBillboardPos->x;
	matOut._42 = pBillboardPos->y;
	matOut._43 = pBillboardPos->z;
}

void DxBillboardLookAt ( D3DXMATRIX &matOut, const D3DXVECTOR3 *pBillboardPos, D3DXVECTOR3 *CarmeraPos, D3DXVECTOR3 *UpPos )
{
	D3DXVECTOR3	View = *CarmeraPos - *pBillboardPos;
	...
	matOut._11 = Left.x;	matOut._21 = Up.x;	matOut._31 = View.x;
	matOut._12 = Left.y;	matOut._22 = Up.y;	matOut._32 = View.y;
	matOut._13 = Left.z;	matOut._23 = Up.z;	matOut._33 = View.z;
...
void DxBillboardLookAtHeight ( D3DXMATRIX &matOut, const D3DXVECTOR3 *pBillboardPos, const D3DXMATRIX &matView )
{
	matOut._11 = matView._11;	matOut._21 = 0.f;	matOut._31 = matView._31;
	matOut._12 = 0.f;			matOut._22 = 1.f;	matOut._32 = 0.f;
	matOut._13 = matView._13;	matOut._23 = 0.f;	matOut._33 = matView._33;
...
void DxBillboardLookAtGround ( D3DXMATRIX &matOut, const D3DXVECTOR3 *pBillboardPos, D3DXVECTOR3 *CarmeraPos )
{
	D3DXVECTOR3	View = *CarmeraPos - *pBillboardPos;
	D3DXVec3Normalize ( &View, &View );
	View.y = 100.f;
...
void DxBillboardLookAtDir ( D3DXMATRIX &matOut, const D3DXVECTOR3 *pBillboardPos, const D3DXVECTOR3 *CarmeraPos )
{
	D3DXVECTOR3	View = *pBillboardPos - *CarmeraPos;
	D3DXVec3Normalize ( &View, &View );
	...
	if ( (View.x==0.f) && (View.z==0.f) )
	{
		...
		{
			matOut._11 = 1.f;		matOut._21 = 0.f;		matOut._31 = 0.f;
			matOut._12 = 0.f;		matOut._22 = 1.f;		matOut._32 = 0.f;
			matOut._13 = 0.f;		matOut._23 = 0.f;		matOut._33 = 1.f;
			matOut._41 = 0.f;		matOut._42 = 0.f;		matOut._43 = 0.f;
	...
	matOut._11 = Left.x;	matOut._21 = View.x;	matOut._31 = Up.x;
	matOut._12 = Left.y;	matOut._22 = View.y;	matOut._32 = Up.y;
	matOut._13 = Left.z;	matOut._23 = View.z;	matOut._33 = Up.z;
...
void DxBillboardLookAtDir ( D3DXMATRIX &matOut, const D3DXVECTOR3 *Dir )
{
	...
	matOut._11 = Left.x;	matOut._21 = vDir.x;	matOut._31 = Up.x;
	matOut._12 = Left.y;	matOut._22 = vDir.y;	matOut._32 = Up.y;
	matOut._13 = Left.z;	matOut._23 = vDir.z;	matOut._33 = Up.z;
...
void DxBillboardLookAtDirXZ ( D3DXMATRIX &matOut, D3DXVECTOR3 *Dir )
{
	...
	matOut._11 = Dir->x;	matOut._21 = Up.x;	matOut._31 = Left.x;
	matOut._12 = Dir->y;	matOut._22 = Up.y;	matOut._32 = Left.y;
	matOut._13 = Dir->z;	matOut._23 = Up.z;	matOut._33 = Left.z;
    ...
    const D3DXVECTOR2& vTexUV )
{
	...
	//	상태 저장, 셋팅
	DWORD	dwZEnable, dwZWriteEnable, dwFogEnable, dwLighting, dwCullMode, dwSrcBlend, dwDestBlend;
				...
				const BOOL bNew, const DWORD dwTexSize )
{
	...
	//	상태 저장, 셋팅
	DWORD	dwZEnable, dwZWriteEnable, dwFogEnable, dwLighting, dwCullMode, dwSrcBlend, dwDestBlend, dwAlphaBlendEnable;
...
namespace NSMATH
{
	...
	{
		if ( ((lhs.x + fOffset) > rhs.x) && (lhs.x < (rhs.x + fOffset)) && 
			((lhs.y + fOffset) > rhs.y) && (lhs.y < (rhs.y + fOffset)) )
			return TRUE;
	...
	BOOL IsOffsetSamePos3( const D3DXVECTOR3& lhs, const D3DXVECTOR3& rhs, float fOffset )
	{
		if ( ((lhs.x + fOffset) > rhs.x) && (lhs.x < (rhs.x + fOffset)) && 
			((lhs.y + fOffset) > rhs.y) && (lhs.y < (rhs.y + fOffset)) &&
			((lhs.z + fOffset) > rhs.z) && (lhs.z < (rhs.z + fOffset)) )
			return TRUE;
	...
	float ExportVector2ToFloat( float fX, float fY )
	{
		...
		D3DXVECTOR2 vecEncode = D3DXVECTOR2( fX * 255.f, fY * 255.f );
		vecEncode.x = floorf( vecEncode.x );
		vecEncode.y = floorf( vecEncode.y );
		float fResult = ( ( vecEncode.x * 256.f ) + vecEncode.y ) / 65535.f;	 // 256 - <<8 한다는 개념
		return fResult;
	}
};
