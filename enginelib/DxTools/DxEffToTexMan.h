...
public:
	...
	void EndEffToTex(LPDIRECT3DDEVICEQ pd3dDevice, const SUBPATH* pPath);

protected:
	void EndEffToTex128(LPDIRECT3DDEVICEQ pd3dDevice, const SUBPATH* pPath);
	void EndEffToTex256(LPDIRECT3DDEVICEQ pd3dDevice, const SUBPATH* pPath);
