...
protected:
	...
	BOOL		m_bSnapMode;
	float		m_fSnapGridSize;
	D3DXMATRIX*	m_pmatWorld;
	D3DXMATRIX	m_matBackUp;
	D3DXVECTOR3 m_vSnapMove;
...
public:
	...
	void SetSnap( BOOL bSnapMode, float fSnapGridSize )	{ m_bSnapMode = bSnapMode;	m_fSnapGridSize = fSnapGridSize; }
...
protected:
	void Move_Object();
	BYTE MoveObject( const D3DXVECTOR3& Dir, const D3DXPLANE& sPlane );
	BYTE MoveObject2( const D3DXVECTOR3& vDir, const D3DXVECTOR3& vDir2, const D3DXPLANE& sPlane );
	void MoveObject_Snap( const D3DXVECTOR3& vDir );
	void Rotate_Object();
...
protected:
	...
	BOOL IsCollisionLine( D3DXVECTOR2 vPoint, D3DXVECTOR3 vP1, D3DXVECTOR3 vP2, float fLength ) const;
