...
struct SKY_PROPERTY_102_103
{
	BOOL			m_bSkyEnable;		// 별, 유성
	BOOL			m_bCloudEnable;		// 구름, 번개
...
protected:
    ...
    TextureResource m_textureResCloud;
    TextureResource m_textureResCloudShadow;
...
protected:
    ...
    TextureResource m_textureResSun;
...
protected:
    ...
    TextureResource m_textureResFlare;

	VERTEXCOLORRHW			m_sFlare[4];

protected:
	char					m_szMoonTex[MAX_PATH];
    TextureResource m_textureResMoon;
...
protected:
    ...
    TextureResource m_textureResStar;
...
protected:
    ...
    TextureResource m_textureResUStar;
...
protected:
    ...
    TextureResource m_textureResLighting;
...
protected:
    ...
    TextureResource m_textureResThunder;
    TextureResource m_textureResThunderC;
...
protected:
    ...
    TextureResource m_textureResThunders;
...
public:
	HRESULT FrameMove ( float fTime, float fElapsedTime );
	HRESULT Render ( LPDIRECT3DDEVICEQ pd3dDevice, float fFOV, float fAspect, BOOL bReflect=FALSE );
	HRESULT Render_ReflectMaterial ( LPDIRECT3DDEVICEQ pd3dDevice, float fFOV, float fAspect );
	void Render_AFTER( LPDIRECT3DDEVICEQ pd3dDevice, float fFO, float fAspectV );
	HRESULT Render_Reflect ( LPDIRECT3DDEVICEQ pd3dDevice, float fFOV, float fAspect );
	void RenderGlOW( LPDIRECT3DDEVICEQ pd3dDevice, float fFOV, float fAspect );
