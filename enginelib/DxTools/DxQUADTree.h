...
public:
	...
	virtual BOOL IsCollisionLine ( const D3DXVECTOR3 &vPickRayOrig, const D3DXVECTOR3 &vPickRayDir, float& fLength ) const = 0;

public:
	virtual HRESULT FrameMove ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV, BOOL bGame ) { return S_OK; }
...
namespace NSQUADTREE
{
	...
	HRESULT RenderQUADTree ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV, POBJQUADNODE &pNode, BOOL bGame );
}
