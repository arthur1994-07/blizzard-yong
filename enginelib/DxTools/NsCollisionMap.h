...
typedef std::tr1::unordered_map<std::string, DWORD> MAPTEXINDEX;
typedef MAPTEXINDEX::iterator                       MAPTEXINDEX_ITER;
typedef MAPTEXINDEX::value_type                     MAPTEXINDEX_VALUE;
...
public:
	...
	BOOL IsCollisionLine ( const D3DXVECTOR3& vP1, const D3DXVECTOR3& vP2, D3DXVECTOR3 &vColl, D3DXVECTOR3 &vNor, WORD& wTexIndex ) const;
