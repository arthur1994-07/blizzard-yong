...
namespace NSMaterialManager
{
	void SetLightMapMaterialTool_NM( std::string& strFX )
	{
		strFX = 
			...
			"//---------------------------------------------------------------------------------------------------------- \r\n"
			"//					N o r m a l \r\n"
			"float3 GetNormalTool( VS_OUTPUT_TOOL In ) \r\n"
			"{ \r\n"
			...
			" \r\n"
			"    float3 vNor = GetNormalTool( In ); \r\n"
			" \r\n"
			"	// CubMap 작업. \r\n"
			"	float3 vEyeToVector = normalize(In.m_vPos); \r\n"
			...
			"	\r\n"
			" \r\n"
			"	float fDiffuseDot = saturate( dot( g_vLightDirViewSpace, vNor ) ); \r\n"
			"	vPointColor += g_vLightDiffuse * (fDiffuseDot + fSpec) + g_vLightAmbient; \r\n"
			" \r\n"
			"	//------------------------------------------ CubeMapMask \r\n"
			...
			" \r\n"
			"	//------------------------------------------ CubeMap \r\n"
			"	vColor.xyz = vColor.xyz*(1.f-fCubeMapValue) + texCUBE( CubeTexSampler, vCubeTexcoord ).xyz * fCubeMapValue; \r\n"
			" \r\n"
	...
	//		"	float3 m_vNormal    : TEXCOORD3; \r\n"
	//		"	float3 m_vBinormal  : TEXCOORD4; \r\n"
	//		"	float3 m_vTangent   : TEXCOORD5; \r\n"
	...
	//		"	\r\n"
	//		" \r\n"
	//		"   float fBaseDot = dot( g_vLightDirViewSpace, normalize( In.m_vNormal ) ); \r\n"
	...
	//		"   vPointColor += In.m_vColor0.xyz * (fNormalDot + fSpec); \r\n"
	//		" \r\n"
	//		"	//------------------------------------------ CubeMapMask \r\n"
	//		"	float fCubeMapValue = g_fCubeMapValue; \r\n"
	//		"	{ \r\n"
	...
	void SetAmbientCubeMaterialTool_NM( std::string& strFX )
	{
		strFX = 
			...
			"	Out.m_vTexCoord0 = In.m_vTexCoord0; \r\n"
			" \r\n"
			"	float fDiffuseDot = saturate( dot( g_vLightDirViewSpace, Out.m_vNormal ) ); \r\n"
