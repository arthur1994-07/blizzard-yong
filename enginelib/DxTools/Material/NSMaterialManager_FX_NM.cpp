...
namespace NSMaterialManager
{
	void SetDefaultNM_FX( std::string& strFX )
	{
		strFX = 
			...
			"	float3 m_vPosProjSpace	: TEXCOORD5; \r\n"
			"}; \r\n"
			" \r\n"
			...
			"//---------------------------------------------------------------------------------------------------------- \r\n"
			"//					N o r m a l \r\n"
			"float3 GetNormal( VS_OUTPUT_ALBEDO In, float4 vMaskColor ) \r\n"
			"{ \r\n"
			...
			" \r\n"
			"	float3 vNorOrig = (normalize( In.m_vNormal )+1.f)*0.5f; \r\n"
			" \r\n"
			...
			"	vOut.m_vColor1 = float4(GetNormal( In, vMaskColor ),vColor.w); \r\n"
			...
			"	vOut.m_vColor3.y = ExportVector2ToFloat( min(vAddColor.z * 0.33333333f, 1.f), vNorOrig.x ); \r\n"
			"	vOut.m_vColor3.z = ExportVector2ToFloat( vNorOrig.y, vNorOrig.z ); \r\n"
			"	if ( bSoftAlpha ) \r\n"
			"	{ \r\n"
			...
			"	Out.m_vBinormal = normalize( mul(In.m_vBinormal, g_matWV) ); \r\n"
			"	Out.m_vTangent = normalize( mul(In.m_vTangent, g_matWV) ); \r\n"
			" \r\n"
			"	// Pass the texture coordinate \r\n"
			"	Out.m_vTexCoord0 = In.m_vAlbedoXY_LMZW.xy; \r\n"
			"	Out.m_vLightmapUV = In.m_vAlbedoXY_LMZW.zw; \r\n"
	...
	void SetVoxelColorNM_FX( std::string& strFX )
	{
		strFX = 
			...
			"	float3 m_vTangent		: TEXCOORD3; \r\n"
			"	float3 m_vPosProjSpace	: TEXCOORD4; \r\n"
			"	float3 m_vVoxelColor	: TEXCOORD5; \r\n"
			"}; \r\n"
			" \r\n"
			"struct PS_DEFFERED_OUT		// game 렌더용 \r\n"
			"{ \r\n"
			...
			"}  \r\n"
			" \r\n"
			"float3 GetNormal( VS_OUTPUT_ALBEDO_INSTANCING In, float4 vMaskColor ) \r\n"
			"{ \r\n"
			"    // If using a signed texture, we must unbias the normal map data \r\n"
			"    float3 Normal; \r\n"
			"    Normal.xy = (vMaskColor.wy * 2) - 1; \r\n"
	...
	void SetDecalNM_FX( std::string& strFX )
	{
		strFX = 
			...
			"//---------------------------------------------------------------------------------------------------------- \r\n"
			"//					N o r m a l \r\n"
			"float3 GetNormal( VS_OUTPUT_DECAL In, float4 vMaskColor ) \r\n"
			"{ \r\n"
			"    // If using a signed texture, we must unbias the normal map data \r\n"
			"    float3 Normal; \r\n"
			"    Normal.xy = (vMaskColor.wy * 2) - 1; \r\n"
			...
			" \r\n"
			"	vOut.m_vColor0 = vColor; \r\n"
			"	vOut.m_vColor1 = float4(GetNormal( In, vMaskColor ),vColor.w*g_fDecalNormal); \r\n"
