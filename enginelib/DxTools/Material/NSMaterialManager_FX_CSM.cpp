...
namespace NSMaterialManager
{
	void SetLightMapMaterial_POS_NOR_TEX2_PS30_CSM( std::string& strFX )
	{
		strFX = 
			...
			"   float4 m_vShadowProjectionPos	: TEXCOORD4; \r\n"	// PL2
			"   float4 m_vShadowProjPos_3rd		: TEXCOORD5; \r\n"	// PL1
			"   float3 m_vHalfSpot1				: TEXCOORD6; \r\n"
			"   float3 m_vHalfSpot2				: TEXCOORD7; \r\n"
			"}; \r\n"
			" \r\n"
			"float CascadeShadowSpot( float4 vShadowProjectionPos, sampler __ShadowTexSampler, float fTexSize, float fOffset )  \r\n"
			"{ \r\n"
			"   //------------------------------------------ ShadowMap \r\n"
			...
			"   float fOffsetNew = 0.001f; \r\n"	//"   float fOffsetNew = fOffset*0.001f/vShadowProjectionPos.z; \r\n"
			"   sourcevals[0] = (tex2D( __ShadowTexSampler, ShadowTexC ) + fOffsetNew < fShadowProjZdivW)? 0.f: 1.0f; \r\n"
			"   sourcevals[1] = (tex2D( __ShadowTexSampler, ShadowTexC + float2(1.0/fTexSize, 0) ) + fOffsetNew < fShadowProjZdivW)? 0.f: 1.0f; \r\n"
			"   sourcevals[2] = (tex2D( __ShadowTexSampler, ShadowTexC + float2(0, 1.0/fTexSize) ) + fOffsetNew < fShadowProjZdivW)? 0.f: 1.0f; \r\n"
			"   sourcevals[3] = (tex2D( __ShadowTexSampler, ShadowTexC + float2(1.0/fTexSize, 1.0/fTexSize) ) + fOffsetNew < fShadowProjZdivW)? 0.f: 1.0f; \r\n"
			" \r\n"
			"   // lerp between the shadow values to calculate our light amount \r\n"
			"   float vLightAmount; \r\n"
			"   vLightAmount = lerp( lerp( sourcevals[0], sourcevals[1], lerps.x ), \r\n"
			...
			" \r\n"
			"	Out.m_vShadowProjectionPos = float4(0.f,0.f,0.f,0.f); \r\n"
			"	Out.m_vShadowProjPos_3rd = float4(0.f,0.f,0.f,0.f); \r\n"
			"   Out.m_vHalfSpot1 = float3(0.f,0.f,0.f); \r\n"
			"   Out.m_vHalfSpot2 = float3(0.f,0.f,0.f); \r\n"
			" \r\n"
			"	if ( nPL1==2 ) \r\n"
			"	{ \r\n"
			"		Out.m_vShadowProjectionPos = mul(g_matShadow_PL1, In.m_vPosition); \r\n"
			" \r\n"
			"		// HalfVector \r\n"
			...
			"	if ( nPL2==2 ) \r\n"
			"	{ \r\n"
			"		Out.m_vShadowProjPos_3rd = mul(g_matShadow_PL2, In.m_vPosition); \r\n"
			" \r\n"
			"		// HalfVector \r\n"
			"		float3 vHalf = -Out.m_vPosViewSpace.xyz; \r\n"
			"		vHalf = normalize( vHalf ); \r\n"
			...
			"		float vLightAmountNEW = CascadeShadowSpot( In.m_vShadowProjPos_3rd, ShadowTexSampler_PL2, 1024.f, g_vPos_Range_CL_TOOL[1].w );  \r\n"
			"		{ \r\n"
			"			int i=1; \r\n"
			"			float3 afPosDir = g_vPos_Range_CL_TOOL[i].xyz - In.m_vPosViewSpace; \r\n"
			"			float fLength = length( afPosDir ); \r\n"
	...
	void SetVoxelColorMaterial_PS30_CSM( std::string& strFX )
	{
		strFX = 
			...
			"   float4 m_vShadowProjPos_3rd		: TEXCOORD4; \r\n"	// PL1
			"   float3 m_vHalfSpot1				: TEXCOORD5; \r\n"
			"   float3 m_vHalfSpot2				: TEXCOORD6; \r\n"
			"}; \r\n"
			" \r\n"
			"float CascadeShadowSpot( float4 vShadowProjectionPos, sampler __ShadowTexSampler, float fTexSize, float fOffset )  \r\n"
			"{ \r\n"
	...
	void SetAmbientCubeMaterial_PS30_CSM( std::string& strFX )
	{
		strFX = 
			...
			"   float3 m_vHalfSpot1				: TEXCOORD5; \r\n"
			"   float3 m_vHalfSpot2				: TEXCOORD6; \r\n"
			"	float2 m_vACubeSpot1Spot2		: TEXCOORD7; \r\n"
			"}; \r\n"
			" \r\n"
			"//---------------------------------------------------------------------------------------------------------- \r\n"
