...
public:
	...
	typedef PUTSET::const_iterator	PUTSET_CITER;
...
private:
    ...
    BOOL m_bAltDown;						// Alt 다운중인가
	BOOL m_bCtrlDown;						// Ctrl 다운중인가
	BOOL m_bShiftDown;						// Shift 다운중인가
...
public:
	const PUTSET& GetKeyDownSet   () const { return m_mapKeyDown; }
	const PUTSET& GetMouseDownSet () const { return m_mapMouseKeyDown; }
...
public:
    ...
    BOOL IsMouseMove() { return m_bMouseMove; }
