...
CUIEditBoxIME_Dx9::CUIEditBoxIME_Dx9(EngineDeviceMan* pEngineDevice)
...
HRESULT CUIEditBoxIME_Dx9::Render( LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	V_RETURN( m_EditUI.OnRender( m_fElapsedTime ) );
...
HRESULT CUIEditBoxIME_Dx9::RestoreDeviceObjects( LPDIRECT3DDEVICE9 pd3dDevice )
{
	...
	m_EditUI.SetSize(m_pEngineDevice->GetBackBufferWidth(), m_pEngineDevice->GetBackBufferHeight());
