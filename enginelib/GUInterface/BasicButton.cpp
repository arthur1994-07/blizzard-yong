...
CBasicButton::CBasicButton(EngineDeviceMan* pEngineDevice)
...
{	
	...
	CUIControl* pMouseOver = new CUIControl(m_pEngineDevice);
...
{
	CUIControl* pFlipControl = new CUIControl(m_pEngineDevice);
...
{
	if ( m_pFlipControl )
		m_pFlipControl->SetVisibleSingle ( bFlip );
