...
public:	
	bool IsLoad ();
	bool Load(const std::string& strFileName, bool bLoop, bool bStereo = false);
	bool UnLoad ();
...
public:
	...
	BOOL LoadSet(sc::BaseStream& SFile, WORD SoundVer);

private:
	BOOL LoadSet100(sc::BaseStream& SFile, WORD SoundVer);
