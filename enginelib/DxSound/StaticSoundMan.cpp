...
BOOL	SVecSound::SaveSet ( sc::SerialFile &SFile )
{
	D3DXVECTOR3 vPos( m_matWorld._41, m_matWorld._42, m_matWorld._43 );
...
BOOL	SVecSound::LoadSet ( sc::SerialFile &SFile, WORD VecSoundVer, WORD SoundVer )
{
	D3DXVECTOR3 vPos;
...
BOOL	CStaticSoundMan::SaveSet ( sc::SerialFile &SFile )
{
...
void CStaticSoundMan::Archive( boost::function<void (const TCHAR*)> fun )
{
    SVecSound* pVecSound = m_pVecSoundHead;
    ...
    while (pVecSound)
    {
        fun(pVecSound->m_strFileName.c_str());
        pVecSound = pVecSound->m_pNext;
    }
}
