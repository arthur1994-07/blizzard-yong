#ifndef MIN_versionhelpers_H_INCLUDED_
#define MIN_versionhelpers_H_INCLUDED_
...
BOOL DEF_IsWindows10OrGreater()
{
	return DEF_IsWindowsVersionOrGreater(HIBYTE(_DEF_WIN32_WINNT_WIN10), LOBYTE(_DEF_WIN32_WINNT_WIN10), 0);
}


#endif // MIN_VERSIONHELPERS_H_INCLUDED_