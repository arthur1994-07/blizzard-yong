...
protected:
    ...
    TextureResource m_textureResRain;
    TextureResource m_textureResCircle;
    TextureResource m_textureResRainDrop;
    TextureResource m_textureResSnow;
    TextureResource m_textureResLeaves;

    TextureResource m_textureResGround;
    TextureResource m_textureResRainG;
    TextureResource m_textureResSnowG;
    TextureResource m_textureResFireFly;
...
protected:
    ...
    typedef sc::ObjectPool<FIREFLY>		FIREFLYPOOL;
...
protected:
	...
	public:
		...
		void	Load( sc::SerialFile &SFile, DWORD version );

	protected:
		HRESULT RenderRain ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV );
		HRESULT RenderSnow ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV );
		HRESULT RenderLeaves ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV );
		void RenderFireFly( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV );

		HRESULT RenderGround ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV );
	};
...
public:
	static void OnCreateDevice_STATIC ( LPDIRECT3DDEVICEQ pd3dDevice );
	static void OnDestroyDevice_STATIC ();

    static void OnResetDevice_STATIC ( LPDIRECT3DDEVICEQ pd3dDevice );
	static void OnLostDevice_STATIC ( LPDIRECT3DDEVICEQ pd3dDevice );

private:
	static void OnResetDevice_FireFly_STATIC ( LPDIRECT3DDEVICEQ pd3dDevice );
	static void OnLostDevice_FireFly_STATIC ( LPDIRECT3DDEVICEQ pd3dDevice );
...
private:
	...
	float	CalcSurfaceArea(VERTEX_WORLD* pFV[3]);
