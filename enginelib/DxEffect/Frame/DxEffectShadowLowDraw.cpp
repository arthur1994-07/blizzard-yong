									  ...
									  DWORD dwFVF, LPDIRECT3DSTATEBLOCK9 pSavedSB, LPDIRECT3DSTATEBLOCK9 pEffectSB )
{
	...
	//		{
	//			pd3dDevice->SetVertexShaderConstant ( VSC_MATRIAL, &( pmsMeshs->m_rgMaterials[0].Diffuse ), 1 );	

	//			pd3dDevice->SetMaterial ( &pmsMeshs->m_rgMaterials[0] );


	//			pd3dDevice->SetTexture ( 0, pmsMeshs->m_pTextures[pAttribTable[i].AttribId] );
