...
protected:
	void Save ( sc::SerialFile& SFile, DxReflectTree* pTree );
	void Load ( sc::SerialFile& SFile, PDXREFLECTTREE& pTree );
	void DynamicLoad ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile& SFile, const CLIPVOLUME &sCV, DxReflectTree* pTree );
