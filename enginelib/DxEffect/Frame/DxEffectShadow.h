...
public:
	...
	void DynamicLoad ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile& SFile );
...
public:
	void Create ( LPDIRECT3DDEVICEQ pd3dDevice, VERTEX_WORLD* pVert, WORD* pIndex, DWORD dwFace, D3DXMATRIX& matWorld );
...
public:
	void Save ( sc::SerialFile& SFile );
	void Load ( sc::SerialFile& SFile );
	void DynamicLoad ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile& SFile, const CLIPVOLUME &sCV );

protected:
	void Save ( sc::SerialFile& SFile, DxShadowTree* pTree );
	void Load ( sc::SerialFile& SFile, PDXSHADOWTREE& pTree );
	void DynamicLoad ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile& SFile, const CLIPVOLUME &sCV, DxShadowTree* pTree );
...
protected:
    TextureResource m_textureResSSDay;
    TextureResource m_textureResSSNight;
    TextureResource m_textureResFilter;
...
private:
	...
	//HRESULT ProjectionObj	( LPDIRECT3DDEVICEQ pd3dDevice, DxFrame*		pframeCur, const CLIPVOLUME *pCV, D3DXVECTOR3 *vDir );
	//HRESULT PickingObjD		( LPDIRECT3DDEVICEQ pd3dDevice, DxFrame*		pframeCur, DxFrame *pframeShadow, const CLIPVOLUME *pCV, D3DXVECTOR3 *vDir, DxSetLandMan *pSetLandMan );
	//HRESULT PickingObjP		( LPDIRECT3DDEVICEQ pd3dDevice, DxFrame*		pframeCur, DxFrame *pframeShadow, const CLIPVOLUME *pCV, DxSetLandMan *pSetLandMan );
	//HRESULT PickingObjP		( LPDIRECT3DDEVICEQ pd3dDevice, DxFrame*		pframeCur, DxFrame *pframeShadow, const CLIPVOLUME *pCV, D3DXVECTOR3 *vPos, float fRange, DxSetLandMan *pSetLandMan );
