...
protected:
    ...
    TextureResource m_textureResSpore;
...
protected:
    ...
    typedef sc::ObjectPool<DxEffectSpore::PARTICLE>	PARTICLEPOOL;
	static PARTICLEPOOL*						m_pParticlePool;

    typedef sc::ObjectPool<DxEffectSpore::FIREFLY>	FIREFLYPOOL;
