...
#ifndef DX_EFFECT_MULTI_TEX_H_
#define DX_EFFECT_MULTI_TEX_H_
...
struct DXMATERIAL_MULTITEX_OLD
{
...
struct DXMATERIAL_MULTITEX
{
    ...
    DXMATERIAL_MULTITEX& operator= ( const DXMATERIAL_MULTITEX& rvalue )
    {
        memcpy( &rgMaterial, &rvalue.rgMaterial, sizeof( D3DMATERIALQ ) );
