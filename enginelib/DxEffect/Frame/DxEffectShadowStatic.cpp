...
HRESULT DxEffectShadow::MakeStaticShadow ( LPDIRECT3DDEVICEQ pd3dDevice, const char* szFile, DxSetLandMan *pSetLandMan, DWORD dwTexSize )
{
	...
	////
	//{
 //       m_textureResFilter = TextureManager::GetInstance().LoadTexture(
 //           m_szFilter,
 //           false,
 ...
 //           TEXTURE_EFFECT,
	...
	//	if ( !m_textureResFilter.GetTexture() )
	//	{
	//		char szMsg[256] = "";
 ...
 //       sBackupTarget.Backup( pd3dDevice, DxBackupTarget::TARGET );
...
//}
//
//HRESULT DxEffectShadow::PickingObjD ( LPDIRECT3DDEVICEQ pd3dDevice, DxFrame*	pframeCur, DxFrame *pframeShadow, const CLIPVOLUME *pCV, D3DXVECTOR3 *vDir, DxSetLandMan *pSetLandMan )
//{
//	return S_OK;
//
//	//HRESULT hr = S_OK;
...
//HRESULT DxEffectShadow::PickingObjP	( LPDIRECT3DDEVICEQ pd3dDevice, DxFrame* pframeCur, DxFrame *pframeShadow, const CLIPVOLUME *pCV, DxSetLandMan *pSetLandMan )
//{
//	HRESULT hr = S_OK;
//
//	D3DXVECTOR3	vPos;
...
//
//				pd3dDevice->SetTexture ( 0, m_textureResFilter.GetTexture() );
...
//}
//
//HRESULT DxEffectShadow::PickingObjP	( LPDIRECT3DDEVICEQ pd3dDevice, DxFrame* pframeCur, DxFrame *pframeShadow, const CLIPVOLUME *pCV, D3DXVECTOR3 *vPos, float fRange, DxSetLandMan *pSetLandMan )
//{
//	return S_OK;
//
////	HRESULT hr = S_OK;
...
//HRESULT DxEffectShadow::ProjectionObj ( LPDIRECT3DDEVICEQ pd3dDevice, DxFrame* pframeCur, const CLIPVOLUME *pCV, D3DXVECTOR3 *vDir )	// 간단그림자
//{
//	return S_OK;
//
//	//HRESULT hr = S_OK;
...
//	//				if ( vTemp.y > m_vMin.y )
//	//				{
// //                       float PosY = vTemp.y - vCenter.y;
//	//					pVertex[i].vPos.x = vTemp.x - PosY * (vDir->x/vDir->y);
//	//					pVertex[i].vPos.y = vCenter.y;
//	//					pVertex[i].vPos.z = vTemp.z - PosY * (vDir->z/vDir->y);
//	//				}
//	//				else
//	//				{
...
{
	if ( !m_pBSurface || !m_pSShadowSurface )
		return;
