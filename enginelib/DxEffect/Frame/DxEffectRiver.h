...
#ifndef _ENGINE_LIB_DX_EFFECT_RIVER_H_
#define _ENGINE_LIB_DX_EFFECT_RIVER_H_
...
protected:
	void Save ( sc::SerialFile& SFile, DxWaterTree* pTree );
	void Load ( sc::SerialFile& SFile, PDXWATERTREE& pTree );
	void DynamicLoad ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile& SFile, const CLIPVOLUME &sCV, DxWaterTree* pTree );
...
protected:
    ...
    TextureResource m_textureResDark;
    TextureResource m_textureResFlash;
    TextureResource m_textureResNormal;
    TextureResource m_textureRes1DMap;
...
#endif // _ENGINE_LIB_DX_EFFECT_RIVER_H_
