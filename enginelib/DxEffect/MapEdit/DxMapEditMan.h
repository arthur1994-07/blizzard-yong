...
#include "../../DxTools/DxQUADTree.h"

#include "DxMapBlend.h"

#include "../Mesh/DxStaticPisMan.h"
...
protected:
	struct BASE
	{
		...
		void		SaveFile ( sc::SerialFile &SFile, BOOL bThread );
		void		LoadFile ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile, BOOL bThread );
	...
	public:
		...
		virtual BOOL IsCollisionLine ( const D3DXVECTOR3 &vPickRayOrig, const D3DXVECTOR3 &vPickRayDir, float& fLength ) const;

		virtual HRESULT FrameMove ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV, BOOL bGame );
...
public:
	void LoadSet(char* pFileName, LPDIRECT3DDEVICEQ pd3dDevice, const SUBPATH* pPath);
