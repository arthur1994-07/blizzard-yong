...
protected:
	...
	TextureResource m_textureRes;			// 사용자가 만든 타일 맵.		< Edit, Game >
...
public:
	void	SaveFile_Edit ( sc::SerialFile &SFile );
	void	LoadFile_Edit ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile, const char* pName );
	void	SaveFile_Game ( sc::SerialFile &SFile );
	void	LoadFile_Game ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile, const char* pName );
...
typedef std::tr1::unordered_map<std::string, DxBlendData*> BLENDMAP;
typedef BLENDMAP::iterator					               BLENDMAP_ITER;
typedef BLENDMAP::value_type                               BLENDMAP_VALUE;
...
public:
	...
	void	SaveFile_Edit ( sc::SerialFile &SFile );
	void	LoadFile_Edit ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile );
	void	SaveFile_Game ( sc::SerialFile &SFile );
	void	LoadFile_Game ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile );
