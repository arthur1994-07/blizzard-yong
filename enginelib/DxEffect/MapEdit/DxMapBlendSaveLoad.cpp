...
//												B	L	E	N	D		D	A	T	A
// -----------------------------------------------------------------------------------------------------------------------------------------
void DxBlendData::SaveFile_Edit ( sc::SerialFile &SFile )
{
	SFile << m_dwGrid;
	SFile << m_dwFaces;
	SFile << m_dwVertices;
...
void DxBlendData::LoadFile_Edit ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile, const char* pName )
{
	m_bEnable = FALSE;
...
void DxBlendData::SaveFile_Game ( sc::SerialFile &SFile )
{
	SFile << m_dwGrid;
	SFile << m_dwFaces;
	SFile << m_dwVertices;
...
void DxBlendData::LoadFile_Game ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile, const char* pName )
{
	m_bEnable = FALSE;
...
//														B	L	E	N	D
// -----------------------------------------------------------------------------------------------------------------------------------------
void DxBlend::SaveFile_Edit ( sc::SerialFile &SFile )
{
...
void DxBlend::LoadFile_Edit ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile )
{
...
void DxBlend::SaveFile_Game ( sc::SerialFile &SFile )
{
	int nSize;
	nSize = (int)m_mapBlend.size();
...
void DxBlend::LoadFile_Game ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile )
{
	int nSize;
	std::string	sName;
	SFile >> nSize;
...
//															C	O	L	O	R	
// -----------------------------------------------------------------------------------------------------------------------------------------
void DxColor::SaveFile_Edit ( sc::SerialFile &SFile )
{
...
void DxColor::LoadFile_Edit ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile )
{
	m_bEnable = FALSE;
...
void DxColor::SaveFile_Game ( sc::SerialFile &SFile )
{
	DWORD			dwBPP = 32;
	D3DLOCKED_RECT	lrDst;
	RECT			pRect;
...
void DxColor::LoadFile_Game ( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile &SFile )
{
	m_bEnable = FALSE;
