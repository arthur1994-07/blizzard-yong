...
#define	USE_SOURCE_DECAL			0x00000020	// 문제되는 Decal 이 Ground 로 변한 상태.
...
struct GROUND_PROPERTY : public EFF_PROPERTY
{
	...
	HRESULT LoadFile_DecalProp ( sc::BaseStream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, BOOL bBackUpCache );
...
protected:
	DWORD			m_dwColor;
	VERTEXCOLORTEX	m_pGroundVertex[4];
