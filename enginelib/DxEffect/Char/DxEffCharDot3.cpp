...
const DWORD	DxEffCharDot3::VERSION			= 0x0101;
...
DxEffChar* DxEffCharDot3::CloneInstance ( LPDIRECT3DDEVICEQ pd3dDevice, DxCharPart* pCharPart, DxSkinPiece* pSkinPiece, DWORD dwMaterialNum )
{
	HRESULT hr;
...
HRESULT DxEffCharDot3::InitDeviceObjects ( LPDIRECT3DDEVICEQ pd3dDevice )
{
 ...
 //   m_textureResDot1 = TextureManager::GetInstance().LoadTexture(
 //       m_szDot3Tex_1,
 //       false,
 //       TEXTURE_ADD_DATA::TEXUTRE_TYPE_2D,
 //       EMMM_CHAR_MIPMAP,
 ...
 //   m_textureResDot2 = TextureManager::GetInstance().LoadTexture(
 //       m_szDot3Tex_2,
 //       false,
 //       TEXTURE_ADD_DATA::TEXUTRE_TYPE_2D,
 //       EMMM_CHAR_MIPMAP,
 ...
 //   m_textureResDot3 = TextureManager::GetInstance().LoadTexture(
 //       m_szDot3Tex_3,
 //       false,
 //       TEXTURE_ADD_DATA::TEXUTRE_TYPE_2D,
 //       EMMM_CHAR_MIPMAP,
...
HRESULT DxEffCharDot3::DeleteDeviceObjects ()
{
    ...
    //m_textureResDot1.Clear();
    //m_textureResDot2.Clear();
    //m_textureResDot3.Clear();
...
void	DxEffCharDot3::Render ( LPDIRECT3DDEVICEQ pd3dDevice, const D3DXMATRIX* arrayBoneMatrices, BOOL bPieceRender )
{
//	HRESULT hr = S_OK;
//
//    if ( !m_pmcMesh )	                return;
...
HRESULT DxEffCharDot3::LoadFile_0100 ( sc::BaseStream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	//	Note : 이팩트의 Property 를 저장.
	//
	EFFCHAR_PROPERTY_DOT3_100 pProperty;

	SFile.ReadBuffer ( &pProperty, sizeof(EFFCHAR_PROPERTY_DOT3_100) );
	m_Property.Assign( pProperty );

	return S_OK;
}

HRESULT DxEffCharDot3::LoadFile_0101 ( sc::BaseStream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	//	Note : 이팩트의 Property 를 저장.
	//
...
HRESULT	DxEffCharDot3::LoadFile ( sc::BaseStream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
...
HRESULT	DxEffCharDot3::SaveFile ( sc::BaseStream &SFile )
{
	SFile << TYPEID;
	SFile << VERSION;
