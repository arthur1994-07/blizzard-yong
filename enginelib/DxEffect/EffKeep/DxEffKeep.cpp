...
void DxEffKeepDataMain::Load(const std::string& FileName, LPDIRECT3DDEVICEQ pd3dDevice)
{
...
void DxEffKeepDataMain::Save( sc::SerialFile &SFile )
{
	SFile << VERSION;
...
void DxEffKeepDataMain::Load( sc::BaseStream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	DWORD dwVer;
	SFile >> dwVer;
