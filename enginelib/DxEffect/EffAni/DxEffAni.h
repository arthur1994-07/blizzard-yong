...
public:
	...
	virtual BOOL IsSingleEffLoop()								{ return FALSE; }
...
public:	
	virtual DxEffAni* NEWOBJ( DxSkinAnimation* pAnimContainer ) = 0;
	virtual HRESULT LoadFile(sc::BaseStream& SFile, LPDIRECT3DDEVICEQ pd3dDevice) = 0;
	virtual HRESULT SaveFile(sc::SerialFile& SFile) = 0;
...
public:
	...
	const DxSkinAnimation*	m_rAnimContainer;
...
public:
	...
	void CheckFrameMove( const DxSkinAnimation* pAnimContainer );
...
public:
	virtual HRESULT FrameMove( DxSkinCharEffAniBase* pSkinCharBase, float fTime, float fElapsedTime ) = 0;
	virtual HRESULT	Render( const LPDIRECT3DDEVICEQ pd3dDevice, DxSkinCharEffAniBase* pSkinChar, const D3DXMATRIX& matCurPos, float fAlpha ) = 0;
	//virtual HRESULT	Render( const LPDIRECT3DDEVICEQ pd3dDevice, DxAttBone* pSkinChar, const D3DXMATRIX& matCurPos, float fAlpha ) = 0;
	//virtual HRESULT	Render( const LPDIRECT3DDEVICEQ pd3dDevice, DxVehicle* pSkinChar, const D3DXMATRIX& matCurPos, float fAlpha ) = 0;
...
public:
	HRESULT Create ( LPDIRECT3DDEVICEQ pd3dDevice, const DxSkinAnimation* pAnimContainer )
	{
