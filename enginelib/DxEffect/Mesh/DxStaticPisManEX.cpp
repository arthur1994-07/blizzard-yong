...
{
	pStaticPisEdit = DxPieceContainer::GetInstance().LoadPiece ( pd3dDevice, szSrcName.c_str() );
...
BOOL DxAABBPieceOBJ::IsCollisionLine ( const D3DXVECTOR3& vP1, const D3DXVECTOR3& vP2, D3DXVECTOR3 &vColl, D3DXVECTOR3 &vNor ) const
{
...
void DxAABBPieceOBJ::Save ( sc::SerialFile& SFile )
{
	SFile << vMax;
	SFile << vMin;
	SFile << szSrcName;
...
void DxAABBPieceOBJ::Load ( sc::SerialFile& SFile )
{
	SFile >> vMax;
	SFile >> vMin;
	SFile >> szSrcName;
...
BOOL DxAABBPiece::IsCollisionLine ( const D3DXVECTOR3& vP1, const D3DXVECTOR3& vP2, D3DXVECTOR3 &vColl, D3DXVECTOR3 &vNor, POBJAABB& pObj ) const
{
