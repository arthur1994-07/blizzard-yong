...
HRESULT DxPieceMan::Render ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV )
{
...
HRESULT DxPieceMan::Render_EDIT ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV )
{
...
HRESULT DxPieceMan::Render_SELECT ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV )
{
...
void DxPieceMan::SetPickRay ( D3DXVECTOR3& vPickRayOrig, D3DXVECTOR3& vPickRayDir )
{
	...
	m_vENDPOS = m_vSTARTPOS + (vPickRayDir*100000.f);
}
