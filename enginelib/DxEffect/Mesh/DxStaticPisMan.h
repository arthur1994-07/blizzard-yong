...
public:
	...
	virtual BOOL IsCollisionLine( const D3DXVECTOR3& vP1, const D3DXVECTOR3& vP2, D3DXVECTOR3 &vColl, D3DXVECTOR3 &vNor, POBJAABB& pObj ) const;
...
typedef std::tr1::unordered_map<std::string, DxAABBPiece*> MAPAABBPIECE;
typedef MAPAABBPIECE::iterator	                           MAPAABBPIECE_ITER;
typedef MAPAABBPIECE::value_type                           MAPAABBPIECE_VALUE;
...
public:
	...
	HRESULT Render_SELECT ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV );
	HRESULT Render_EDIT ( LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME *pCV );
