...
public:
	...
	void Load( sc::SerialFile& SFile, DxAnimationMan* pAniManHead );
	void CleanUp();
...
protected:
	...
	struct ANIMESH
	{
		...
		void Save( sc::SerialFile& SFile );
		void Load( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile& SFile, DxAnimationMan* pAniManHead );
		void CleanUp();
...
protected:
	...
	TextureResource m_textureRes;			// Main
	TEXTURE_ALPHA	m_emType;
...
public:
	void Save( sc::SerialFile& SFile );
	void Load( LPDIRECT3DDEVICEQ pd3dDevice, sc::SerialFile& SFile, DxAnimationMan* pAniManHead, const char* pName );
	void CleanUp();
...
protected:
    typedef std::tr1::unordered_map<std::string, DxFrameAniVBTEX*> MAPTEXFRAMEANI;
	typedef MAPTEXFRAMEANI::iterator				               MAPTEXFRAMEANI_ITER;
    typedef MAPTEXFRAMEANI::value_type				               MAPTEXFRAMEANI_VALUE;
...
public:
    ...
    size_t GetSizeFrameAniVBTEX() { return m_mapFrameAni.size(); }
    DxFrameAniVBTEX* GetFrameAniVBTEX(size_t nIndex);
