...
// Desc: Constructor
//-----------------------------------------------------------------------------
CD3DApplication::CD3DApplication(EMSERVICE_PROVIDER emServiceProvider)
    : m_dwDefScrX(800)
    , m_dwDefScrY(600)
    ...
    , m_fFPS(0.0f)
{
    ...
    SetServiceProvider(emServiceProvider);
...
void CD3DApplication::SetServiceProvider(EMSERVICE_PROVIDER emServiceProvider)
{
