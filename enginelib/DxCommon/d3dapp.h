...
#include "../../RanThirdParty/DirectX/Include/d3d9caps.h"
...
public:
    ...
    CD3DApplication(EMSERVICE_PROVIDER emServiceProvider);
    virtual ~CD3DApplication() {}

    void SetServiceProvider(EMSERVICE_PROVIDER emServiceProvider);
...
protected:
	...
	virtual HRESULT FrameMove( BOOL bNotRendering )            { return S_OK; }
