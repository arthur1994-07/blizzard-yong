...
BOOL CCollisionMap::Import( const BOOL bEdit )
{
	...
	VERTEX_WORLD	*pVertices = new VERTEX_WORLD [ dwVertices ];
	DWORD			dwVertexCount = 0;
	memset ( pVertices, 0, dwVertices * sizeof ( VERTEX_WORLD ) );	
	...
	//	VERTEX_WORLD -> D3DXVECTOR3 ( Vec만 사용함 )
...
//
//BOOL CCollisionMap::SaveFile ( sc::SerialFile& SFile )
//{
...
//}
//
//BOOL CCollisionMap::LoadFile_PREV( sc::SerialFile& SFile )
//{	
//	DWORD nMapCells = 0;
