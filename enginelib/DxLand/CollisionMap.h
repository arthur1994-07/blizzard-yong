...
public:
	...
	BOOL	IsCollision_NoneConst ( const D3DXVECTOR3 &vP1, D3DXVECTOR3 &vP2, D3DXVECTOR3* pNor, BOOL bEditor, const DxFrame* pFrame, char* pName, EMCOLLMODE emCullMode );
...
private:
	...
	void	IsCollision_NoneConst ( DxAABBNode *pAABBCur, const D3DXVECTOR3 &vP1, const D3DXVECTOR3 &vP2, D3DXVECTOR3* pNor, BOOL bEditor, EMCOLLMODE emCullMode );
