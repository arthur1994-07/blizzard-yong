...
//}
//
//void DxSkinMesh9_CPU::DrawMeshContainer( IDirect3DDevice9 *pd3dDevice, const CHARSETTING& sSetting, const DxSkeletonMaintain* pSkeleton )
//{
...
// //   pd3dDevice->SetStreamSource( 0, DxDynamicVB::g_sVB_PNTI.pVB, 0, 32 );
//
...
// //                       if( pLocked )
// //                       {
// //                           PBYTE pbVerticesDest = (PBYTE)pLocked;
//
...
//	//				        );
//
// //                           sSetting.pmtrlPiece[iAttrib].m_dwDyVertStart = DxDynamicVB::g_sVB_PNTI.UnlockVB( dwVertexSizeFULL, sAttribTable.VertexCount );
//
...
//	//				        //{
//	//				        //	// Note : 렌더하기 위한 백업.
//	//				        //	pmtrlPiece[iAttrib].m_dwDyVertStart = DxDynamicVB::g_sVB_PNTI.nVertexCount;
//
...
//	//);
//
// //   DxDynamicVB::g_sVB_PNTI.UnlockVB( dwVertexSizeFULL, sAttribTable.VertexCount );
//}
//
...
////				        );
////
////				        pmtrlPiece[iAttrib].m_dwDyVertStart = DxDynamicVB::g_sVB_PNTI.UnlockVB( dwVertexSizeFULL, sAttribTable.VertexCount );
////                    }
////                }
////			}
////
...
//}
//
//void DxSkinMesh9_CPU::Load( sc::SerialFile& SFile, IDirect3DDevice9 *pd3dDevice )
//{
...
//}
//
//void DxSkinMesh9_CPU::LoadToon( sc::SerialFile& SFile, IDirect3DDevice9 *pd3dDevice )
//{
//	//DWORD dwCount(0L);
...
//	//strName += pName;
//
//	//strName = sc::util::ChangeExtName( strName.c_str(), _T("lod_sw") );
//
//	//BOOL bOpened = SFile.OpenFile( FOT_READ, strName.c_str() );
//	//if ( !bOpened )		return;
//
...
//}
//
//void DxSkinMesh9_CPU::LoadLOD( sc::SerialFile& SFile, IDirect3DDevice9 *pd3dDevice )
//{
//	//DWORD dwCount(0L);
//	//SMeshContainer* pCur = m_pMeshContainerHead;
//	//while( pCur )
