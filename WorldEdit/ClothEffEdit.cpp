...
IMPLEMENT_DYNAMIC(CClothEffEdit, CPropertyPage)
CClothEffEdit::CClothEffEdit()
	: CPropertyPage(CClothEffEdit::IDD),
	m_pClothEff(NULL),
	m_bInitDlg(FALSE)
{
}
...
void CClothEffEdit::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CClothEffEdit, CPropertyPage)
...
// CClothEffEdit 메시지 처리기입니다.
void CClothEffEdit::SetInstance ( DxEffectCloth *pClothEff )
{
...
void CClothEffEdit::OnBnClickedButtonTexture()
{
...
void CClothEffEdit::OnBnClickedButtonApply()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void CClothEffEdit::OnBnClickedButtonOk()
{
	//	Note : 속성을 적용.
	//
	OnBnClickedButtonApply();

	m_pSheetTab->SetActiveBackUpPage( CLOTHPAGEINDEX );
	m_pClothEff = NULL;
}

void CClothEffEdit::OnBnClickedButtonCancel()
{
	CMainFrame *pFrame = (CMainFrame *) AfxGetApp()->m_pMainWnd;
	CWorldEditView *pView = (CWorldEditView*) pFrame->GetActiveView ();
...
void CClothEffEdit::OnBnClickedRadioStop()
{
	CMainFrame *pFrame = (CMainFrame *) AfxGetApp()->m_pMainWnd;
	CWorldEditView *pView = (CWorldEditView*) pFrame->GetActiveView ();
...
void CClothEffEdit::OnBnClickedRadioPlay()
{
	m_ClothProperty.m_bPlay = true;
	m_pClothEff->SetProperty ( m_ClothProperty );
}

void CClothEffEdit::OnBnClickedButtonPointselect()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.	
...
void CClothEffEdit::OnBnClickedButtonPointdelete()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
BOOL CClothEffEdit::OnSetActive()
{
...
void CClothEffEdit::OnBnClickedButtonWinddir()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	m_pSheetTab->ActiveDirectionPage ( (D3DXVECTOR3*) &m_ClothProperty.m_vWindDirection, CLOTHPAGEINDEX );
}

void CClothEffEdit::OnBnClickedCheckEachRender()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CButton* pButton;
	pButton = (CButton*)GetDlgItem( IDC_CHECK_EACH_RENDER );
