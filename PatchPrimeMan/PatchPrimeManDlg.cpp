...
#include "./Thread/LPatchThread.h"
#include "./Thread/HttpPatchThread.h"
...
CPatchPrimeManDlg::~CPatchPrimeManDlg()
{
    delete m_pPath;
    m_pPath = NULL;
}
...
void	CPatchPrimeManDlg::BEGIN_PATCH ()
{
	...
	m_pThread = new CHttpPatchThread( &sParam, g_szAppPath, AfxGetThread()->m_nThreadID, m_pPath );
