...
namespace InstanceSystem
{
	...
	class CCertificationMachineCountryMode : public IInstanceFieldMode
	{
	public:
	...
	public:
		CCertificationMachineCountryMode ( GLGaeaServer* _pServer
		...
		virtual ~CCertificationMachineCountryMode ( void ) { }
	};
