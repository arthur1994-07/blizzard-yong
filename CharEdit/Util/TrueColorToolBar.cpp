...
BOOL CTrueColorToolBar::LoadToolBar(UINT unToolBarID, UINT unBitmapID)
{
	ASSERT_VALID(this);
...
BOOL CTrueColorToolBar::LoadBitmap(LPCTSTR lpszResourceName)
{
	CBitmap bitmap;
	...
	// 툴바의 크기와 배경색을 설정 한다.
	imageList.Create(16, 16, ILC_COLORDDB | ILC_MASK, 11, 1);
