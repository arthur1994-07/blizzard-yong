...
bool CWhiteRockXml::SetXMLNodeText( TIXMLOLD::TiXmlElement* rootElem, const CString& strChildPath, const CString& strData )
{
    TIXMLOLD::TiXmlElement* nodeElem = NULL;
	TIXMLOLD::TiXmlNode* nodeChild = NULL;
...
TIXMLOLD::TiXmlElement* CWhiteRockXml::GetChildElement( TIXMLOLD::TiXmlElement* rootElem, const CString& strChildPath )
{
	...
	TIXMLOLD::TiXmlElement* nodeElemChild = rootElem; 	
...
bool CWhiteRockXml::GetXMLNodeText(TIXMLOLD::TiXmlElement* rootElem, const CString& strChildPath, CString& strNodeText )
{
	TIXMLOLD::TiXmlElement* nodeElem = NULL;
	TIXMLOLD::TiXmlNode* nodeChild = NULL;
